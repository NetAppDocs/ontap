...
summary: "When you enable NFSv4 referrals, ONTAP provides intra-SVM referrals to NFSv4 clients. Intra-SVM referral is when a cluster node receiving the NFSv4 request refers the NFSv4 client to another logical interface on the storage virtual machine."
---

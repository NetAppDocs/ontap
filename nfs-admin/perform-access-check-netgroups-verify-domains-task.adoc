...
summary: "By default, ONTAP performs an additional verification when evaluating client access for a netgroup. The additional check ensures that the client’s domain matches the domain configuration of the storage virtual machine. Otherwise, ONTAP denies client access."
---

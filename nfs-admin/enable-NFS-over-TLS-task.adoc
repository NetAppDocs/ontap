...
Make sure that NFS is enabled on the SVM and that an NFS data LIF exists. Confirm that NFS is configured on the SVM:
+
[source,cli]
----
...
:table-caption: TLS and mTLS Client Behavior Matrix

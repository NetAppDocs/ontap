...
sidebar: sidebar
keywords:
summary: "You can enable NFSv4 referrals on storage virtual machines by enabling the options -v4-fsid-change and -v4.0-referrals or -v4.1-referrals. Enabling NFSV4 referrals can result in faster data access for NFSv4 clients that support this feature."
---

...
summary: "Beginning with ONTAP 9.11.1, you can take advantage of LDAP _fast bind_ functionality for faster and simpler client authentication requests. To use this functionality, the LDAP server must support fast bind functionality."
---
...
* The administrator's UID number and GID number must be populated and queryable for fast bind to succeed. 

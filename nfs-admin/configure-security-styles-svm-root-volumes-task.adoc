...
summary: "You configure the storage virtual machine root volume security style to determine the type of permissions used for data on the root volume of the SVM."
---

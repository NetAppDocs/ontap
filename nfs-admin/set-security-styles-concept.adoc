...
summary: "Security styles can be set on FlexVol volumes and qtrees. Security styles can be set manually at the time of creation, inherited automatically, or changed at a later time."
---

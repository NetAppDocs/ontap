...
sidebar: sidebar
keywords: use, ldap
summary: "An LDAP server enables you to centrally maintain user information. If you store your user database on an LDAP server in your environment, you can configure your storage system to look up user information in your existing LDAP database."
---

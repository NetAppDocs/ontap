...
Before you can view or modify limits on storepool resources, you need to enable the storepool limit controls. Administrators can use the follow commands to enable or disable storepool limit controls. 

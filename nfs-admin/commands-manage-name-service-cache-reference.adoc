...
summary: "You can manage name service cache by modifying the time to live value. The TTL value determines how long name service information is persistent in cache."
---

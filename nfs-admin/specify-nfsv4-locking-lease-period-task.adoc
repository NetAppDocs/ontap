...
summary: "To specify the NFSv4 locking lease period, you can modify the -v4-lease-seconds option. Shorter lease periods speed up server recovery while longer lease periods are beneficial for servers handling a very large amount of clients."
---

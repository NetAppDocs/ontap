...
The TTL is measured in milliseconds. Beginning with ONTAP 9.17.1 and later, the default is 1 hour (3,600,000 milliseconds).  In ONTAP 9.16.1 and earlier, the default is 24 hours (86,400,000 milliseconds).  The allowed range for this value is 1 minute (60000 milliseconds) through 7 days (604,800,000 milliseconds).
a|

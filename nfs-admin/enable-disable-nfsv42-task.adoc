...
By default, NFSv3 is enabled in all supported versions of ONTAP 9. Beginning with ONTAP 9.9.1, NFSv4.1 is enabled by default; in earlier releases, it is disabled by default. 
...
NOTE: FPolicy monitoring of NFSv4.2 file access events is not supported. If you configure FPolicy monitoring, you need to disable NFSv4.2 on the SVM.

...
NOTE: FPolicy monitoring of NFSv4.2 file access events is not supported. If you configure FPolicy monitoring, you need to disable NFSv4.2 on the SVM. For reference, see link:nas-audit/supported-file-operation-filter-fpolicy-nfsv4-concept.html[Supported file operation and filter combinations that ONTAP FPolicy monitors for NFSv4].

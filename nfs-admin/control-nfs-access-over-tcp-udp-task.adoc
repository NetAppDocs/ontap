...
summary: "You can enable or disable NFS access to storage virtual machines over TCP and UDP by modifying the -tcp and -udp parameters, respectively. This enables you to control whether NFS clients can access data over TCP or UDP in your environment."
---

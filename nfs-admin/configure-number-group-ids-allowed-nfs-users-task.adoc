...
.Related information
* https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-KBs/How_does_AUTH_SYS_Extended_Groups_change_NFS_authentication[Knowledge base: AUTH_SYS Extended Groups changes for NFS authentication for ONTAP 9^]

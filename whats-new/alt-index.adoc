...
* ref:../s3-config/create-bucket-lifecycle-rule-task.html[S3 bucket lifecycle management]

For a full list of new features and enhancements in ONTAP 9.13.1, see xref:9131.adoc[What's new in ONTAP 9.13.1].

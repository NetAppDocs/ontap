...
As shown in the table below, interoperability details for Trellix and Trend Micro are maintained on the NetApp Interoperability Matrix. Interoperability details for Trellix, Deep Instinct, and OPSWAT can also be found on the partner websites. Interoperability details for Sentinel One, Symantec, Deep Instinct, OPSWAT, and other new partners will be maintained by the partner on their websites.   
...
* link:https://docs.trellix.com/bundle/endpoint-security-storage-protection-2.3.x-product-guide/page/GUID-58044D4D-91E6-4F1C-892C-605783676063.html[NetApp configuration on Trellix ePO - On-prem managed endpoints (trellix.com)^]
...
* link:https://www.sentinelone.com/resources/datasheets/threat-detection-for-netapp/[Threat Detection For NetApp^]
|N/A

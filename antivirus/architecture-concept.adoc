...
You must install the ONTAP Antivirus Connector and third-party antivirus software on the same Vscan server.
...
* *Antivirus software*
+
This is third-party software that scans files for viruses or other malicious code. You specify the remedial actions to be taken on infected files when you configure the software.

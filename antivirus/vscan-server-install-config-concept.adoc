...
Follow the instructions in the readme file provided by NetApp to install and configure the ONTAP Antivirus Connector. Alternatively, follow the instructions on the link:https://docs.netapp.com/us-en/ontap/antivirus/install-ontap-antivirus-connector-task.html[Install ONTAP Antivirus Connector page].

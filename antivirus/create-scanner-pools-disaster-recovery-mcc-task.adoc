...
+
`vserver vscan scanner-pool create -vserver _data_SVM|site_Admin_SVM_ -scanner-pool _scanner_pool_ -hostnames _Vscan_server_hostnames_ -privileged-users _privileged_users_`
+
...
+
`vserver vscan scanner-pool show -vserver _data_SVM|site_Admin_SVM_ -scanner-pool _scanner_pool_`
+

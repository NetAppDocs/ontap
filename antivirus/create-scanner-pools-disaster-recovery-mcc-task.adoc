...
+
----
cluster_A::> vserver vscan scanner-pool create -vserver cifssvm1 -
scanner-pool pool1_for_site1 -hostnames scan1 -privileged-users cifs
\u1,cifs\u2

cluster_B::> vserver vscan scanner-pool create -vserver cifssvm1 -
...
+
----
cluster_A::> vserver vscan scanner-pool show -vserver cifssvm1 -scanner-pool pool1_for_site1

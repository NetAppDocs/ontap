...
+
`vserver vscan scanner-pool create -vserver <data_SVM|site_Admin_SVM> -scanner-pool <scanner_pool> -hostnames <Vscan_server_hostnames> -privileged-users <privileged_users>`
+
...
+
`vserver vscan scanner-pool show -vserver <data_SVM|site_Admin_SVM> -scanner-pool <scanner_pool>`
+

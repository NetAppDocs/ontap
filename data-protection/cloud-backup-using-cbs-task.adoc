...
Cloud Backup supports FlexVol read-write volumes and data-protection (DP) volumes. Beginning with ONTAP 9.12.1, Cloud Backup supports FlexGroup volumes and SnapLock volumes.

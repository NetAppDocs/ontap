...
Beginning with ONTAP 9.19.1, System Manager no longer supports NetApp Backup and Recovery. See Manage backups for your ONTAP systems with NetApp Backup and Recovery for more information about using NetApp Backup and Recovery with NetApp Console.

...
Beginning with general availability in ONTAP 9.9.1, link:../snapmirror-active-sync/index.htm[SnapMirror active sync] provides Zero Recovery Time Objective (Zero RTO) or Transparent Application Failover (TAF) to enable automatic failover of business-critical applications in SAN environments.

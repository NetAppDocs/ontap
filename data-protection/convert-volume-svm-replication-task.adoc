...
. Create an SVM replication relationship between the source and destination SVMs, as described in link:replicate-svm-config-task.html[Replicating SVM configurations].
+

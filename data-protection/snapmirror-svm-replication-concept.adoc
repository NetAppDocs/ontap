...
* Starting with ONTAP 9.2, _SnapMirror unified replication,_ in which the destination is configured for both DR and long-term retention.
...
|===
2+a| Configuration replicated 2+a| `*‑identity‑preserve true*`| `*‑identity‑preserve false*`
a|

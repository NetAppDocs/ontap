...
a|
Beginning with ONTAP 9.14.1. See link:https://docs.netapp.com/us-en/ontap/consistency-groups/protect-task.html[Protect a consistency group] for more information.

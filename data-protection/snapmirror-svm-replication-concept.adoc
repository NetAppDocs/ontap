...
Beginning with ONTAP 9.12.1, SnapMirror SVM replication is supported with FabricPool and FlexGroup volumes working in conjunction. Prior to 9.12.1, any two of these features worked together, but not all three in together.
a|
MetroCluster
a|

 ...
 ** Volume association with user and system defined snapshot policies are not copied to the destination SVM.
...
IPsec enable
a|
Not supported beginning with ONTAP 9.19.1.

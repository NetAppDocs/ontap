...
* Beginning with ONTAP 9.13.1, ONTAP uses quick-resync by default to reduce resync time. ONTAP automatically uses quick-resync when the following conditions exist:

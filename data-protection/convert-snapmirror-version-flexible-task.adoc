...
----
+
For complete command syntax, see the link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-quiesce.html[man page^].
+
[NOTE]
====
...
----
+
For complete command syntax, see the link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-break.html[man page^].
+
[NOTE]
====
You must run this command from the destination SVM or the destination cluster.
...
----
+
For complete command syntax, see the link:https://docs.netapp.com/us-en/ontap-cli-9141//snapmirror-delete.html[man page^].
+
[NOTE]
====
You must run this command from the destination SVM or the destination cluster.
...
To improve resync time, you can use the `-quick-resync` option, but you should be aware that storage efficiency savings can be lost. For complete command syntax, see the man page: link:https://docs.netapp.com/us-en/ontap-cli-9141/snapmirror-resync.html#parameters.html[SnapMirror resync command^].

...
----
+
For complete command syntax, see the link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-quiesce.html[man page^].
+
[NOTE]
====
...
To improve resync time, you can use the `-quick-resync` option, but you should be aware that storage efficiency savings can be lost. For complete command syntax, see the man page: link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-resync.html#parameters.html[SnapMirror resync command^].

...
+
To improve resync time, you can use the `-quick-resync` option, but you should be aware that storage efficiency savings can be lost. For complete command syntax, see the man page: link:https://docs.netapp.com/us-en/ontap-cli-9111/snapmirror-resync.html#parameters.html[SnapMirror resync command].
+
[NOTE]
====

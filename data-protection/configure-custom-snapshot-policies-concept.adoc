...
summary: "A snapshot policy defines how the system creates snapshots. The policy specifies when to create snapshots, how many copies to retain, and how to name them."
---

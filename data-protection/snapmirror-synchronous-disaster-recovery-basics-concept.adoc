...
| NDMP/NDMP restore
| ONTAP 9.13.1
| Both the source and destination cluster must be running ONTAP 9.13.1 or later to perform dump- or SMTape-based NDMP backup of SnapMirror synchronous volumes.  NDMP restores, either dump- or SMTape-based, are not supported to destination volumes in a SnapMirror active sync or SnapMirror synchronous relationship. 
...
* SnapCenter
* SnapLock volumes
* Dump or SMTape-based NDMP restore to destination volumes in a SnapMirror active sync or SnapMirror synchronous relationship

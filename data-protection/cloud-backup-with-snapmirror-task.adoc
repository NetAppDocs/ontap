...
[.lead]
Beginning with ONTAP 9.9.1, you can use _SnapMirror cloud_ when you want to transition your data protection workflows to the cloud. Instead of legacy backup-to-tape architectures, you can use object storage as an alternative repository for long-term data retention and archiving. You can use providers like Amazon S3, Azure Blob, Google Cloud Storage, StorageGRID, or ONTAP S3 as your cloud object store.

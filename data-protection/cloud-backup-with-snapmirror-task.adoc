...
Beginning with ONTAP 9.18.1, SnapMirror cloud supports back up and restore operations for MetroCluster FlexGroup volumes. Before ONTAP 9.18.1, SnapMirror cloud only supports MetroCluster FlexVol volumes.

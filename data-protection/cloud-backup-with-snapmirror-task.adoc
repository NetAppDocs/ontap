...
[NOTE]
If you are using ONTAP 9.16.1 and you are performing a single file restore in a FlexGroup volume, you should only restore files to a new directory in the FlexGroup volume to avoid overwriting existing files.

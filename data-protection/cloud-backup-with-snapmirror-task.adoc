...
[NOTE]
SnapMirror Cloud replication that is managed by SystemManager only supports StorageGrid and ONTAP S3 as the object storage destination. Other providers are not supported.

...
[.lead]
Beginning with ONTAP 9.9.1, you can use _SnapMirror cloud_ when you want to transition your data protection workflows to the cloud. Instead of legacy backup-to-tape architectures, you can use object storage as an alternative repository for long-term data retention and archiving. You can use providers like Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID, or ONTAP S3 as your cloud object store.

Beginning with ONTAP 9.9.1, you can use System Manager to back up and restore your data.
...
Before you configure SnapMirror cloud backups, you need to add a cloud object store.

...
* Beginning with ONTAP 9.13.1, you can use asynchronous SnapMirror to protect xref:../consistency-groups/index.html[consistency groups]. Beginning with ONTAP 9.14.1, you can use asynchronous SnapMirror to replicate volume-granular Snapshots to the destination cluster using the consistency group relationship. For more information, see xref:../consistency-groups/protect-task.html#configure-asynchronous-snapmirror-protection[Configure asynchronous SnapMirror protection].

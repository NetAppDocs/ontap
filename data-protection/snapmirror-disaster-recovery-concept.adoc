...
* Beginning with ONTAP 9.13.1, you can use asynchronous SnapMirror to protect xref:../consistency-groups/index.html[consistency groups]. Beginning with ONTAP 9.14.1, asynchronous SnapMirror can also be used to replicate volume-granular Snapshots to the secondary storage site.

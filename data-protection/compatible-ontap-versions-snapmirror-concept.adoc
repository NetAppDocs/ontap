...
** The ONTAP version on the target cluster must be no more than 2 on premises versions newer and no more than two cloud versions newer, as shown in the table below.

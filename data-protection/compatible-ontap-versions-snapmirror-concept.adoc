...
+
[NOTE]
ONTAP 9.16.0 is an exception to the cloud-only rule by providing support for ASA r2. Currently, ASA r2 configurations only support SnapMirror relationships between ASA r2 to ASA r2 configurations with ONTAP 9.16.0.
...
h|	ONTAP version…	21+h|											Interoperates with these previous ONTAP versions…																																				

...
.Steps
You should perform this task using the ONTAP CLI.
...
. Hover your cursor over the source name, click image:icon_kabob.gif[Menu options icon], and in the menu click *Reverse resync*.
...
. Locate the SVM, hover your cursor over the SVM name, click image:icon_kabob.gif[Menu options icon], and in the menu click *Stop*.
. In the *Stop storage VM* window, click *Stop*.
. On the source cluster, locate the SVM (which is now the source SVM of the reversed relationship), hover your cursor over the SVM name, click image:icon_kabob.gif[Menu options icon], and in the menu click *Activate destination storage VM*.
...
. When you are returned to the *Relationships* page, hover your cursor over the SVM name again, click image:icon_kabob.gif[Menu options icon], and in the menu click *Reverse resync*.

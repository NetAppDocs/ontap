...
. Hover your cursor over the source name, click image:icon_kabob.gif[Menu options icon], and click *Reverse resync*.
...
. Locate the storage VM, hover your cursor over the storage VM name, click image:icon_kabob.gif[Menu options icon], and click *Stop*.
. In the *Stop storage VM* window, click *Stop*.
. On the source cluster, navigate to *Protection > Replication*, and locate the storage VM you want to reactivate, hover your cursor over the storage VM name, click image:icon_kabob.gif[Menu options icon], and click *Activate destination storage VM*.
...
. When you return to the *Replication* page, hover your cursor over the storage VM name again, click image:icon_kabob.gif[Menu options icon], and click *Reverse resync*.

--
.System Manager ONTAP 9.8 through ONTAP 9.16.1 
--
...
. Locate the storage VM, hover your cursor over the storage VM name, click image:icon_kabob.gif[Menu options icon], and click *Stop*.
. In the *Stop storage VM* window, click *Stop*.
. On the source cluster, locate the storage VM (which is now the source SVM of the reversed relationship), hover your cursor over the SVM name, click image:icon_kabob.gif[Menu options icon], and click *Activate destination storage VM*.
. In the *Activate destination storage VM* window, select *Activate the destination storage VM and break the relationship* and click *Activate*.
. When you return to the *Relationships* page, hover your cursor over the storage VM name again, click image:icon_kabob.gif[Menu options icon], and click *Reverse resync*.

...
summary: "A snapshot policy specifies when to create snapshots, how many copies to retain, and how to name them. A snapshot policy can contain up to five job schedules."
---

...
Beginning with ONTAP 9.11.1, you can enable native FPolicy for storage VMs using System Manager.  With FPolicy Native Mode, you can allow or disallow specific file extensions. To learn more, see link:insights-fpolicy-best-practice-task.html[Best practice: Configure native FPolicy]. 

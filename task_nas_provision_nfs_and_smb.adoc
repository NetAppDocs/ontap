...
* link:nfs-admin/case-sensitivity-file-directory-multiprotocol-concept.html[Learn about case-sensitivity of file and directory names in an ONTAP NFS multiprotocol environment]

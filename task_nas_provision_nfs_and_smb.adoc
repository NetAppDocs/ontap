...
= Provision NAS storage for both NFS and SMB with ONTAP System Manager
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
You can create FlexVol volumes, or for large file systems with high performance requirements, you can create FlexGroup volumes.  See  link:./flexgroup/create-task.html[Create FlexGroup volumes].

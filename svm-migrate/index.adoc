...
| MetroCluster SVMs
| ONTAP 9.16.1
| You can migrate an existing SVM from either an HA pair into a MetroCluster configuration or move an SVM from one MetroCluster configuration to an HA pair. You cannot migrate an SVM from one MetroCluster configuration to another MetroCluster configuration.

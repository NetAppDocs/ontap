...
* The source and destination clusters must have the SnapMirror Synchronous link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html[license installed].

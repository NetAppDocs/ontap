...
* The source and destination clusters must have the SnapMirror synchronous link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html[license installed]. This license is included with link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one[ONTAP One].

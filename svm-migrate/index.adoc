...
This non-disruptive SVM relocation capability is supported on AFF systems in ONTAP 9.10.1 and 9.11.1. Beginning with ONTAP 9.12.1, this capability is supported on both FAS and AFF systems and on hybrid aggregates.
...
Follow link:https://docs.netapp.com/us-en/asa-r2/manage-data/migrate-svm.html[these steps^] for ASA r2 SVM migration.

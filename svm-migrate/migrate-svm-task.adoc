...
Beginning with ONTAP 9.19.1, direct-attachment FC and FC-NVMe configurations are supported for certain AFF, ASA r2 and FAS systems.  Direct-attachment configurations do not support SVM migration.

...
[.lead]
There are considerations and limitations to be aware of when using SnapMirror Business Continuity.
...
SM-BC also offers support for other features in ONTAP, including:

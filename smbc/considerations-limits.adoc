...
To learn more about this process, see xref:../tape-backup/transfer-data-ndmpcopy-task.html[Transfer data using `ndmp` copy] and xref:../tape-backup/smtape-engine-concept.html[About SMTape engine for FlexVol volumes].

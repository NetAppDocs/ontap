...
[Note]
This workflow applies to ONTAP 9.8 and 9.9. Beginning with ONTAP 9.10.1, it is recommended that you manage xref:../consistency-groups/index.adoc[consistency groups] through System Manager or with the ONTAP REST API.

...
In the event of a concurrent failover, I/O is expected to fail as the primary path of the LUN may return `LU_NOT_SUPPORTED`. This failure can be mitigate by seeing the Knowledge Base article _link to be added_.

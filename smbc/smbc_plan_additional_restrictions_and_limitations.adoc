...
h| S. No h| Platform 2+h| Endpoints per HA for SM-BC 2+h| Overall sync and SM-BC endpoints per HA
h|
h|
h| ONTAP 9.8, 9.9.1 h| ONTAP 9.10.1 h| ONTAP 9.8, 9.9.1 h| ONTAP 9.10.1
...
h| Limits of objects in an SM-BC relationship h| Count
...
// BURT 1387138
// BURT 1431859, 01 DEC 2021
// issue #326,   19 DEC 2021 

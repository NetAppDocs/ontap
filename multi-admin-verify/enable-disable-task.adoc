...
TIP: If you are using MAV with Autonomous Ransomware Protection, define a new or existing approval group that is responsible for approving ransomware protection pause, disable, and clear suspect requests.

...
NOTE: If you need to disable multi-admin verification functionality without MAV administrator approval, contact NetApp Support and mention the following link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/How_to_disable_Multi-Admin_Verification_if_MAV_admin_is_unavailable[NetApp Knowledge Base: How to disable Multi-Admin Verification if MAV admin is unavailable^].
...
. New rule-protected command for 9.18.1
. New rule-protected command for 9.19.1
...
// 2026 July 13, CONTAP 657531
// 2026 Apr 29, ONTAPDOC-3844

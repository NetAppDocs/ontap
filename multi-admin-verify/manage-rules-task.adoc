...
You can create rules to protect link:../multi-admin-verify/index.html#rule-protected-commands[these commands] beginning with the ONTAP version in which protection capability for each command first became available.

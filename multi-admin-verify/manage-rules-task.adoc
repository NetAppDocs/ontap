...
| Modify a rule | `security multi-admin-verify rule modify -operation _“protected_operation”_ [_parameters_]`
|Delete a rule | `security multi-admin-verify rule delete -operation _“protected_operation”_`

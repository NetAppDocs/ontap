...
You can create rules to protect the following command beginning with ONTAP 9.13.1:
...
The rules for MAV system-default commands, the `security multi-admin-verify` link:../multi-admin-verify/index.html#how-multi-admin-verification-works[commands], cannot be altered.

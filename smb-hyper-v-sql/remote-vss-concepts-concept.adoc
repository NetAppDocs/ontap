...
summary: "You should be aware of certain concepts that are required to understand how Remote VSS is used by backup services with Hyper-V over SMB configurations."
---
= Remote VSS concepts
:icons: font
:imagesdir: ../media/

...
+
For information about using SnapManager with Hyper-V over SMB configurations, see the https://docs.netapp.com/us-en/snapmanager-hyper-v/index.html[SnapManager for Hyper-V Documentation].

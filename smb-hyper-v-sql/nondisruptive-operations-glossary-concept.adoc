...
summary: "There are certain concepts about nondisruptive operations that you should understand before you configure your Hyper-V or SQL Server over SMB solution."
---

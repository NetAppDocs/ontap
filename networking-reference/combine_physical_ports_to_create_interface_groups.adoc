...
permalink: networking-reference/combine_physical_ports_to_create_interface_groups.html
...
Starting in ONTAP 9.8, interface groups are automatically placed into an appropriate broadcast domain about one minute after the first physical port is added to the interface group.

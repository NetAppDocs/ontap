...
= SAN management overview with System Manager
:toc: macro
:toclevels: 1
:hardbreaks:
:nofooter:
...
[.lead]
The topics in this section show you how to configure and manage SAN environments with System Manager in ONTAP 9.7 and later releases.

...
+
In this example, users will be able to access JIT elevation for 45 minutes at a time. Users can initiate JIT sessions for a maximum of 30-days after their configured start date.

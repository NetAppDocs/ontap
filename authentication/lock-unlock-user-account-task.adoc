...
Learn more about `security login lock` and `security login unlock` in the link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=security+login[ONTAP command reference^].

...
If your TOTP secret key is lost, contact your storage administrator to link:authentication/disable-totp-secret-key-task.html[have the key disabled]. After your key is disabled, you can use your first authentication method to log in and configure a new TOTP.

...
+
[NOTE]
Beginning with ONTAP 9.19.1, you must enter a valid TOTP code or scratch code to delete your TOTP secret key using the CLI. You cannot delete your TOTP secret key using the REST API. 

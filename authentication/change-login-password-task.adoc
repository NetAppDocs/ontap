...
[NOTE]
You can use the `security login role config modify` command to modify the password rules for accounts associated with a given role. For more information, see the link:https://docs.netapp.com/us-en/ontap-cli-9141/security-login-role-config-modify.html[command reference^].

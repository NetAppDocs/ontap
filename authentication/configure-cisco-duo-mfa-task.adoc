...
Learn more about `security login duo show` in the link:https://docs.netapp.com/us-en/ontap-cli//security-login-duo-show.html[ONTAP command reference^].
...
Learn more about `security login duo group show` in the link:https://docs.netapp.com/us-en/ontap-cli//security-login-duo-group-show.html[ONTAP command reference^].
...
Learn more about `security login duo group delete` in the link:https://docs.netapp.com/us-en/ontap-cli//security-login-duo-group-delete.html[ONTAP command reference^].

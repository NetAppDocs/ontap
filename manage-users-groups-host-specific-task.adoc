...
.	Click image:icon_arrow.gif[right arrow] in the *Windows* section.

.	Click the *Groups* tab, then click  image:icon_dropdown_arrow.gif[down arrow] next to a group name to view details about that group.
...
a| Edit a group
a|
. Next to the group name, click image:icon_kabob.gif[kebab icon], then click *Edit*.
...
+
*Note:*  You can also delete a single group by clicking image:icon_kabob.gif[kebab icon] next to the group name, then clicking *Delete*.
...
a| Edit a user
a|
. Next to the user name, click image:icon_kabob.gif[kebab icon], then click *Edit*.
...
. Click image:icon_delete_with_can_white_bg.gif[delete icon].
+
*Note:* You can also delete a single user by clicking image:icon_kabob.gif[kebab icon] next to the user name, then clicking *Delete*.

a| Change user password
a|
. Next to the user name, click image:icon_kabob.gif[kebab icon], then click *Change Password*.
...
.	Click image:icon_arrow.gif[right arrow] in the *UNIX* section.

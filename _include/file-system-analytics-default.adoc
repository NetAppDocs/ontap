...
+ 
To learn more about capacity analytics and Activity Tracking, see link:../task_nas_file_system_analytics_enable.html[Enable File System Analytics]. Learn more about `volume create` in the link:https://docs.netapp.com/us-en/ontap-cli/volume-create.html[ONTAP command reference^].

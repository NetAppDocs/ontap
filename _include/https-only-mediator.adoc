...
* If you plan to use ONTAP Mediator to monitor multiple MetroCluster IP configurations, the support depends on your Mediator type, ONTAP version, and OS. Refer to
...
** You plan to configure ONTAP Mediator with HTTPS monitor one or more MetroCluster IP configurations. 

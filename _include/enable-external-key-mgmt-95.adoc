...
+
NOTE: In a MetroCluster environment, you must run this command on both clusters. Learn more about `security key-manager setup` in the link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-setup.html[ONTAP command reference^].
...
+
Learn more about the commands described in this procedure in the link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-show-key-store.html[ONTAP command reference^].
+
----
...
// 2025 October 10-17, ONTAPDOC-3363, GH-2716, NADIAA, updates from PR review

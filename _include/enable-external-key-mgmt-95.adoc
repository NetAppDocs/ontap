...
In MetroCluster configurations, after an external key manager has been configured on both sites, you can run the `volume encryption conversion start` command to convert plain text volumes to encrypted volumes.

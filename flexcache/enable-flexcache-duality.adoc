...
Modifying the service policy an exisiting LIF can be disruptive. It requires the LIF to be taken down and brought back up with a listener for the new service. TCP *should* recover from this quickly, but be aware of potential impact.

...
NOTE: For more thorough documentation on FlexCache duality, see link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works[ONTAP S3 multiprotocol support^].

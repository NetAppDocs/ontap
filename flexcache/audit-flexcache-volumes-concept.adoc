...
** The number of extensions in an FPolicy configuration is limited to 20KB. When the the number of extensions used in an FPolicy configuration on a FlexCache volume exceeds 20KB, the EMS message `nblade.fpolicy.extn.failed` is triggered.

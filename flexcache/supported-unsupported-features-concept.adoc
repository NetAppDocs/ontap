...
Supported for FlexVol origin volumes beginning with ONTAP 9.10.1, and supported for FlexGroup origin volumes beginning with ONTAP 9.13.1. See link:../anti-ransomware/use-cases-restrictions-concept.html#unsupported-configurations

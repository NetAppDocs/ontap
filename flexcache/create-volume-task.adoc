...
Beginning in ONTAP 9.5, FlexCache supports FlexVol volumes as origin volumes and FlexGroup volumes as FlexCache volumes.  Beginning in ONTAP 9.7 both FlexVol volume and FlexGroup volumes are supported as origin volumes. 

.Before you begin

* You must be running ONTAP 9.5 or later

* If you are running ONTAP 9.6 or earlier, you must link:add-license-task.html[add a FlexCache license].
+
A FlexCache license is not required for ONTAP 9.7 or later.

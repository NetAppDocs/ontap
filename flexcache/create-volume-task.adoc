...
* If you are running ONTAP 9.6 or earlier, you must link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html[add a FlexCache license].
+

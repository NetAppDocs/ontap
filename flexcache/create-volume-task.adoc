...
* Ensure FlexCache volume names are 197 characters or less.
...
. If the FlexCache volume is on a different ONTAP cluster than the origin volume, create a cluster peer relationship:
...
// 2026-Sept-1, CONTAP-735842
// 2025-Dec-8, ONTAPDOC-3406
// 4-Nov-2025, ONTAPDOC-3348

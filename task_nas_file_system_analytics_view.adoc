...
keywords: netapp, ontap, data, file, files, system, analytics, explorer, File System Analytics, inactive data, capacity analytics, active data, historical data
...
[.lead]
After File System Analytics (FSA) is enabled, by default you can view the root directory contents of a selected volume sorted by the spaced used in each subtree.

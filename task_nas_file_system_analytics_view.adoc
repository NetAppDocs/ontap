...
[.lead]
After File System Analytics (FSA) is enabled, by default you can view the root directory contents of a selected volume sorted by the space used in each subtree.

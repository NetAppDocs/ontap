...
If you are using System Manager in ONTAP 9.7 or earlier, see link:https://docs.netapp.com/us-en/ontap-sm-classic/index.html[ONTAP System Manager Classic documentation^]

...
Beginning in ONTAP 9.14.1, automated host discovery of NVMe/TCP controllers is enabled by default.  You only need to manually enable this functionality if it was previously disabled. 

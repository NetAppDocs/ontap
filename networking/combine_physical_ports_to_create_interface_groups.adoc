...
== Create an interface group or Link Aggregate Group (LAG)
...
image:/media/AddLag01.png[Add lag graphic]
...
== Add a port to an interface group or Link Aggregate Group (LAG)
...
== Remove a port from an interface group or Link Aggregate Group (LAG)
...
== Delete an interface group or Link Aggregate Group (LAG)

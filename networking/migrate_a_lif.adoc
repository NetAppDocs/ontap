...
+
To work around this restriction, you must create an iSCSI LIF on the destination node. For information about guidelines for creating an iSCSI LIF, see https://docs.netapp.com/us-en/ontap/san-admin/index.html[SAN administration^].

...
+
To work around this restriction, you must create an iSCSI LIF on the destination node. Learn about link:../san-admin/asa-iscsi-lif-fo-task.html#manage-iscsi-lifs-using-the-ontap-cli[creating iSCSI LIFs].

...
summary: "An IPspace defines a distinct IP address space in which storage virtual machines reside."
---
...
Beginning with ONTAP 9.19.1, ONTAP improves TCP data transfer performance over lossy, high-latency WAN links by integrating two modern loss-recovery features into the ONTAP TCP stack: PRR and RACK.

link:networking/improve-tcp-wan-performance.html[Learn more about improving TCP WAN performance with PRR and RACK]

...
.System Manager
--
*Beginning with ONTAP 9.12.0, you can use System Manager to revert a network interface to its home port.*

.Steps

. Select *Network > Overview > Network Interfaces*.

. Select image:/media/icon_kabob.gif[kebob icon] *> Revert* beside the network interface you want to change.

...
To view the capacity of a LIF, run the `network interface capacity details show` command.
...
For instructions on how to convert from IPv4 to IPv6, see link:https://docs.netapp.com/us-en/ontap/software_setup/iipv4-to-1pv6-conversion-task.html[Convert from IPv4 to IPv6].

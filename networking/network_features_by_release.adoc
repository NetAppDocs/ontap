...
// automatic detection and repair recommendations for network wiring issues, Internet Protocol security (IPsec) certificate authentication November 2021/ONTAP 9.10.1, IE-406, IE-407, and IE-408,
//
...
link:auto_detect_wiring_issues.html[Automatic detection and repair recommendations for network wiring issues]

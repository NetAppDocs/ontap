...
a|System Manager includes more control over networking functions, including:
...
link:https://docs.netapp.com/us-en/ontap/networking/add_a_broadcast_domain.html[Add a broadcast domain]

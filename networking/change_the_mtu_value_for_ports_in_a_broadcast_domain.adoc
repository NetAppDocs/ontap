...
.System Manager
--
Beginning with ONTAP 9.12.0, you can use System Manager to modify the MTU value for a broadcast domain to change the MTU value for all ports in that broadcast domain.

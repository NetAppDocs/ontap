...
.Disable anti-replay
You should disable IPsec anti-replay protection on ONTAP (default configuration) and the IPsec clients. If not disabled, fragmentation and multi-path (redundant route) will not be supported.

...
[NOTE]
====
Beginning with ONTAP 9.19.1, ONTAP improves TCP data transfer performance over lossy, high-latency WAN links by integrating two loss-recovery features into the ONTAP TCP stack: PRR and RACK. 
link:improve-tcp-wan-performance.html[Learn about improving TCP WAN performance with PRR and RACK]
====

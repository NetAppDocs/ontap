...
summary: "Introducing management information bases."
...
For more information about SNMP support in ONTAP systems, see https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf[TR-4220: SNMP Support in Data ONTAP^].

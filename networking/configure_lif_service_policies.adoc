...
cluster1::> network interface service-policy create -vserver _vm1 -policy svm1_data_policy -services data-nfs,data-cifs,data-core -allowed-addresses 10.1.0.0/16
....
+
...
cluster1::> network interface service-policy create -vserver cluster1 -policy intercluster1 -services intercluster-core -allowed-addresses 10.1.0.0/16
....
...
svm1      svm1_data_policy           data-core: 10.1.0.0/16
                                     data-nfs: 10.1.0.0/16
                                     data-cifs: 10.1.0.0/16

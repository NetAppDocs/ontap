...
* If you have a large number of LIFs in your cluster, you can verify the LIF capacity supported on the cluster by using:
...
. Select image:/media/icon_add.gif[add icon].

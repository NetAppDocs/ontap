...
.System Manager
--
*Beginning with ONTAP 9.12.0, use System Manager to add or remove IP addresses to or from a subnet.*

.Steps

. Select *Network > Overview > Subnets*.

. Select image:/media/icon_kabob.gif[kebob icon] *> Edit* beside the subnet you want to change.

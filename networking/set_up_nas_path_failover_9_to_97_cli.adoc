...
* xref:networking/set_up_nas_path_failover_98_and_later_cli.adoc[ONTAP 9.8 and later NAS path failover workflow]

If you want details about network components and management, you should use the network management reference material:

* xref:networking_reference.index.adoc[Network management overview]

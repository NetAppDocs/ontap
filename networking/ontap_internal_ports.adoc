...
[.lead]
The following table lists the TCP and UDP ports that ONTAP uses internally and their functions. ONTAP uses these ports for various functions, such as establishing intracluster LIF communication. 

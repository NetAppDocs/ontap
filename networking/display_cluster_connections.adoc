...
Learn more about `network connections active show-protocols` in the link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols[ONTAP command reference^].

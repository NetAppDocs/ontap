...
NOTE: On AFX platforms, TLS hardware offload supports NFS, S3, and FabricPool (ONTAP 9.19.1 and later) front-end traffic types. NVMe/TCP is not supported on AFX platforms because AFX does not support SAN/block protocols.

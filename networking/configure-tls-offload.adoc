...
The 4-port 2-port CX6-DX 40/100 GbE, 2-port CX7 40/100 GbE, and 2-port CX7 40/100/200/400 GbE cards are supported on the following AFF and FAS platforms:
...
NOTE: On ASA r2 systems, TLS hardware offload applies to front-end protocol traffic only (for example, NVMe/TCP). FabricPool and S3 are not supported on ASA r2 systems.

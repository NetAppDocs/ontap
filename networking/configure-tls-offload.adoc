...
The 4-port CX7 10/25 GbE, 2-port CX6-DX 40/100 GbE, and 2-port CX7 40/100 GbE cards are supported on the following AFF and FAS platforms:
...
The 2-port CX6-DX 40/100 GbE, 2-port CX7 40/100 GbE, and 2-port CX7 40/100/200/400 GbE cards are supported on the following AFF and FAS platforms:
...
The 2-port CX6-DX 40/100 GbE, 2-port CX7 40/100 GbE, and 2-port CX7 40/100/200/400 GbE cards are also supported on the following ASA r2 platforms:

* ASA A1K
* ASA A90
* ASA A70

The 4-port CX7 10/25 GbE, 2-port CX6-DX 40/100 GbE, and 2-port CX7 40/100 GbE cards are also supported on the following ASA r2 platforms:
...
NOTE: On ASA r2 systems, TLS hardware offload applies to NVMe/TCP traffic only. NFS over TLS, FabricPool, and S3 are not supported on ASA r2 platforms.

NOTE: On AFX platforms, TLS hardware offload supports NFS, S3, cluster peering encryption, and FabricPool (ONTAP 9.19.1 and later) front-end traffic types. NVMe/TCP is not supported on AFX platforms because AFX does not support SAN/block protocols.

...
. Select the access protocol you want to enable for the SVM.
. Complete the configuration for the selected access protocol.
+
...
+ 
This option is available in ONTAP 9.19.1 and later on AFF and ASA systems.  
+
...
This enables active-active multipathing for all SAN protocols.  If selected, this setting cannot be changed later.
| FC or NVMe/FC
a|
* Configure FC Ports
* Symmetric Active-Active Multipathing
...
. For all protocols, select *Manage administrator account* if you want to manage the storage VM administrator account. 
+

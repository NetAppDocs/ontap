...
summary: You must create a Storage VM (SVM) to serve data to clients.
---
...
Beginning with ONTAP 9.19.1, SVM administrators can manage and monitor their storage VMs using the new SVM dashboard. Use the management network interface IP address and the vsadmin password to access the SVM dashboard. 
...
a|Rules
a|Select image:icon_add.gif[Add icon] to create rules.
...
// 2026 February 23, ONTAPDOC-3654

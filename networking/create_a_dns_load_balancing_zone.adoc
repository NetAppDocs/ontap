...
If the load balancing zone already exists, the LIF is added to it. For more information about the command, see the https://docs.netapp.com/us-en/ontap-cli[ONTAP command reference^].

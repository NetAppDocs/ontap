...
The 4-port CX7 10/25 GbE, 2-port CX6-Dx 40/100 GbE, and 2-port CX7 40/100 GbE cards are supported on the following platforms:
...
The 4-port 2-port CX6-Dx 40/100 GbE, 2-port CX7 40/100 GbE, and 2-port CX7 40/100/200 GbE cards are supported on the following platforms:

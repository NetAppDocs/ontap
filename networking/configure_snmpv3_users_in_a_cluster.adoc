...
FIPS will not allow you to choose *none* for the privacy protocol. As a result, it is not possible to configure an authNoPriv SNMPv3 user in FIPS mode.
...
FIPS will not allow you to choose *none* for the privacy protocol.

...
+
Learn more about the link:https://docs.netapp.com/us-en/ontap-cli/vserver-object-store-server-show.html[`vserver object-store-server bucket modify`] command in the ONTAP command reference.
+

...
. Select *Governance* mode to activate a time-based lock that allows _Write once, read many (WORM)_ permissions on the objects. The objects can, however, be deleted by administrator users with specific permissions.

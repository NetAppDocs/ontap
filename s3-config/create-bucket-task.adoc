...
See txref:../flexgroup/index.html[FlexGroup volumes management] for more information.
+
...
//for the above, use lab on demand to test differences between SM and CLI

...
Beginning with ONTAP 9.19.1, you can use conditions to enforce conditional writes for object uploads and conditional deletes for object deletes. Conditional writes and deletes provide a way to prevent overwrites or unintended deletes of objects. 
...
Beginning with ONTAP 9.19.1, you can use conditions to enforce conditional writes for object uploads and conditional deletes for object deletes. The following example creates a bucket policy statement condition to enforce conditional writes for bucket1: 

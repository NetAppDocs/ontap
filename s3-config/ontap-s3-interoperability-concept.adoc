...
* FlexClone technology (volumes, files, and LUNs)
...
* Nested QoS policies
+
link:../performance-admin/policy-group-assignment-restrictions.html[QoS policy group assignment restrictions]
...
* Volume move is supported for individual member volumes that make up a FlexGroup volume.
...
* FabricPool cloud tier (link:../s3-config/index.html[native S3 only])
* FabricPool local tier (link:../s3-multiprotocol/index.html[NAS volumes only])
* link:../flexcache/supported-unsupported-features-concept.html#supported-features[FlexCache volumes] (beginning with ONTAP 9.18.1)

a|

* Volume move is not supported for FlexGroup volumes that are used by S3 buckets.
* FPolicy
* Qtrees
* Quotas
...
// 2026-Aug-5, GitHub issue #2099
// 2025-Mar-25. GitHub issue #2009
// 2026-Mar-25, GitHub issue #1988
// 2026-Feb-12, GitHub issue #1981

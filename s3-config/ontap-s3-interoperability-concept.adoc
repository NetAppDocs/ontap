...
* SyncMirror (SyncMirror mirrored aggregates are supported in MetroCluster configurations beginning with ONTAP 9.14.1. SyncMirror is not supported outside of a MetroCluster configuration.)

...
You can use the `volume object-store tiering show` command to view the tiering status of a FabricPool volume. For more information, see the link:https://docs.netapp.com/us-en/ontap-cli-9131/[Command Reference].

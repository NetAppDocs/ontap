...
* A link:install-license-aws-azure-ibm-task.html[FabricPool license] is required when tiering to Azure Blob Storage from on-prem ONTAP clusters.

* No license is required if you are using Azure Blob Storage from Cloud Volumes ONTAP or Azure NetApp Files.

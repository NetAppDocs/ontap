...
---
= ONTAP FabricPool volume archiving video
:icons: font
:imagesdir: ../media/
...
https://www.youtube.com/embed/El2QA3iEFuk?rel=0[NetApp video: Archiving volumes with FabricPool (backup + volume move)^]

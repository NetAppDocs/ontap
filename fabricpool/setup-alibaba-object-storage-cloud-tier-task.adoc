...
* A link:install-license-aws-azure-ibm-task.html[FabricPool license] is required when tiering to Alibaba Cloud Object Storage from on-prem ONTAP clusters. 
...
// 2026-Apr-23, ONTAPDOC-3753 & BLUEXPDOC-1130

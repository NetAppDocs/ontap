...
* A link:https://console.netapp.com/cloud-tiering[NetApp Cloud Tiering license] is required when tiering to Alibaba Cloud Object Storage. For more information, see link:install-license-aws-azure-ibm-task.html[Install a FabricPool license on an ONTAP cluster].

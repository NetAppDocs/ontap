...
+
If you need additional capacity on an AFF system, if you use Amazon S3 on a non-AFF system, or if you upgrade from an existing cluster, you need a link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html[FabricPool license].
+

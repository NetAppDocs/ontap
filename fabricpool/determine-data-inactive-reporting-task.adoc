...
* When you have existing HDD aggregates, navigate to *Storage > Tiers* and click image:icon_kabob.gif[Menu Options] for the aggregate on which you want to enable inactive data reporting.

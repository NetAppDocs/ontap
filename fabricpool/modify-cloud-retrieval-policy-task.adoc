...
summary: "You can change a volume's cloud retrieval policy by using the -cloud-retrieval-policy option introduced in ONTAP 9.8."
---
= Modify an ONTAP volume's cloud retrieval policy
:icons: font
:imagesdir: ../media/

...
Network Time Protocol (NTP) configuration is required to ensure the time is synchronized between clusters. link:../system-admin/manage-cluster-time-concept.html[Learn about how to configure NTP].
...
Amazon S3) as cloud tiers for AFF and FAS systems. A Cloud Tiering license is not required when using
...
NetApp Cloud Tiering licenses (including add-on or extensions to preexisting FabricPool licenses) are
activated in the NetApp Console. Learm more about link:https://docs.netapp.com/us-en/data-services-cloud-tiering/task-licensing-cloud-tiering.html[setting up Cloud Tiering licenses^].
...
// 2026-Apr-10, removed Auto Balance from list of unsupported features. AB was depreciated and is no longer relevant.
// 2025-Sept-10, BLUEXPDOC-872
// 2025-Aug-22, ONTAPDOC-3231

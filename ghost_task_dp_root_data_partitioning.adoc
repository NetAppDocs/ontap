...
System Manager does not support root-data or root-data-data partitioning. For information on root-data or root-data-data partitioning see the https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html[Disk and Aggregates Power Guide].

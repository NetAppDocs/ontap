...
* The origin and cache clusters must be link:../flexcache-writeback/flexcache-write-back-enable-task.html[cluster peered]
* The server virtual machines (SVMs) on the origin and cache cluster must be link:../flexcache-writeback/flexcache-write-back-enable-task.html[vserver peered] with the FlexCache option. 

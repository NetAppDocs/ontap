...
Please refer to the link:../flexcache-writeback/flexcache-write-back-guidelines.adoc[FlexCache write-back guidelines] page for the most current recommendations regarding max file size.

...
summary: "ONTAP enables you to configure a login banner or a message of the day to communicate administrative information to System Manager and CLI users of the cluster or storage virtual machine."
---

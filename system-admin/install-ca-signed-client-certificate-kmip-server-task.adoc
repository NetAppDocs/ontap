...
summary: "The certificate subtype of Key Management Interoperability Protocol, along with the client and server-ca types, specifies that the certificate is used for mutually authenticating the cluster and an external key manager, such as a KMIP server."
---

...
[NOTE]
The SnapMirror Cloud and S3 SnapMirror licenses are not included with ONTAP One. They are part of the ONTAP One Compatibility bundle, which you can get for free if you have ONTAP One and https://docs.netapp.com/us-en/ontap/data-protection/install-snapmirror-cloud-license-task.html[request separately].

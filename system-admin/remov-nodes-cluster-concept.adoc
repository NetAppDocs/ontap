...
* If the nodes you are removing contains LUNs that use Selective LUN Mapping, you should remove the nodes from the LUN map before removing the nodes from the cluster. 

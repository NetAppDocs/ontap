...
summary: "While SET requests are logged by default, GET requests are not. However, you can use the settings command to control whether get requests sent from ONTAP HTML, the ONTAP CLI or from the ONTAP APIs are logged in the file."
---
...
// 2o26-April-10, GitHub issue #1974

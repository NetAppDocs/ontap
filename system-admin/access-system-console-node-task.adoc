...
summary: "If a node is hanging at the boot menu or the boot environment prompt, you can access it only through the system console. You can access the system console of a node from an SSH connection to the node’s SP or to the cluster."
---

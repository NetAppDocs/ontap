...
If the cluster has SnapMirror peer relationships, then you also need to re-create those relationships. For more information, see the _Data Protection Power Guide_.

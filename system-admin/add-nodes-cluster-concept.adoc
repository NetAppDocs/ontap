...
* Install and configure your new storage system by reviewing the hardware requirements, preparing your site, and installing and cabling the hardware components (controllers, storage shelves and switches). See the following ONTAP hardware systems documentation for details:
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html[AFF A-series systems^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html[AFF C-series systems^]
...
See the link:https://docs.netapp.com/us-en/ontap-systems-switches/index.html[Switch documentation for ONTAP hardware systems^]
+
...
[NOTE]
====
For more information on setting up a cluster using the setup GUI, see the link:../task_admin_add_nodes_to_cluster.html[node management documentation]. Learn more about `cluster setup` in the link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html[ONTAP command reference^].
====

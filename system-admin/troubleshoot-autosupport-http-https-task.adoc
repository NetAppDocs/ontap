...
+
For assistance troubleshooting any returned errors, see link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/ONTAP_AutoSupport_(Transport_HTTPS_and_HTTP)_Resolution_Guide[ONTAP AutoSupport (Transport HTTPS and HTTP) Resolution Guide^].

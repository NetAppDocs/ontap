...
summary: "On certain hardware platforms, software is customized to support a new onboard controller in called the Baseboard Management Controller. The BMC has command-line interface commands you can use to manage the device remotely."
---

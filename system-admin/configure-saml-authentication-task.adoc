...
summary: "Beginning with ONTAP 9.3, you can configure Security Assertion Markup Language authentication for web services."
---
...
+
NOTE: The `user_name` value is case-sensitive. Unless you are using Entra ID, include only the user name, and do not include any portion of the domain. If you are using Entra ID, you can create the user name with the domain, for example _user_name@domain.com_.
+

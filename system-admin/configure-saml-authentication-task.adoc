...
For more information, refer to the AD FS documentation.

--

.Cisco Duo
--
Refer to the link:https://duo.com/docs/sso-netapp-ontap[Cisco Duo documentation^] for information about configuring Cisco Duo as an ONTAP IdP.
--

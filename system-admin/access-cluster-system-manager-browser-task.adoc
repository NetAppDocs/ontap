...
+
NOTE: Beginning with ONTAP 9.11.1, when you log in to System Manager, you can specify the locale.  For ONTAP 9.10.1 and earlier, the locale is detected from the browser. To change the locale, you have to change the locale of the browser.

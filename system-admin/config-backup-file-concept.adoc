...
summary: "Configuration backup files are archive files that contain information for all configurable options that are necessary for the cluster, and the nodes within it, to operate properly."
---

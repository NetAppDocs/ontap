...
* Beginning with ONTAP 9.15.1, administrators can link:../authentication/dynamic-authorization-overview.html[configure Dynamic Authorization^] to provide adaptive authentication to SSH users based on the user's trust score.

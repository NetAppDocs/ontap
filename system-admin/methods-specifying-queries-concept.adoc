...
You must enclose raw file names in double quotes to prevent the interpretation of special characters. This also applies to special characters used by the clustershell, for example, "?" displays contextual help.

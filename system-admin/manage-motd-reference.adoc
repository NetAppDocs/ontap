...
For a list of escape sequences that can be used to dynamically generate content for the MOTD, see the link:https://docs.netapp.com/us-en/ontap-cli-9141//security-login-motd-modify.html#parameters[command reference].

...
summary: "Cluster administrators administer the entire cluster and the storage virtual machines it contains. SVM administrators administer only their own data SVMs."
---

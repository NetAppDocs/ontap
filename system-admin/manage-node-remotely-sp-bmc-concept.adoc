...
summary: "You can manage a node remotely using an onboard controller, called a Service Processor or Baseboard Management Controller. This remote management controller is included in all current platform models. The controller stays operational regardless of the operating state of the node."
---

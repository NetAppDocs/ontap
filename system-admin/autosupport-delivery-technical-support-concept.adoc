...
If you want to disable AutoSupport OnDemand, but keep AutoSupport enabled, use the command: link:https://docs.netapp.com/us-en/ontap-cli-95/system-node-autosupport-modify.html#parameters[`system node autosupport modify -ondemand-state disable`].

...
summary: "You can enable or disable a web service for the cluster or a storage virtual machine, display the settings for web services, and control whether users of a role can access a web service."
---

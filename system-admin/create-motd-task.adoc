...
+
Learn more about `security login motd modify` and parameters to enable the MOTD to display dynamically generated content in the link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-cmpr-980/security%5F%5Flogin%5F%5Fmotd%5F%5Fmodify.html[ONTAP command reference^]. Be sure to check for your ONTAP version.

...
summary: "You can create a message of the day to communicate information to authenticated CLI users. The MOTD is displayed in a console session or an SSH session after a user is authenticated but before the clustershell prompt appears."
---

...
xref:system-manager-concept.adoc[Understanding ONTAP System Manager]

xref:access-cluster-system-manager-browser-task.adoc[Accessing a cluster by using the ONTAP System Manager browser-based graphic interface]

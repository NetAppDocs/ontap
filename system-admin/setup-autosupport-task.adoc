...
+
NOTE: You will need to complete SMTP configuration in the next procedural step so that recipients of your internal support organization receive AutoSupport messages with attachments.

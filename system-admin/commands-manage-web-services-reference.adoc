...
summary: "You use the vserver services web commands to manage the availability of web services for the cluster or a storage virtual machine. You use the vserver services web access commands to control a role’s access to a web service."
---

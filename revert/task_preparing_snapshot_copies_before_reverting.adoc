...
[.lead]
Before you revert an ONTAP cluster from any version of ONTAP 9, you must disable all snapshot policies and delete any Snsnapshots that were created after upgrading to the current release.

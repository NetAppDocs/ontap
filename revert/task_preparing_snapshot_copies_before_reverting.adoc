...
[.lead]
Before reverting an ONTAP cluster from any version of ONTAP 9, you must disable all Snapshot copy policies and delete any Snapshot copies that were created after upgrading to the current release.

...
+
For more information about deleting load-sharing relationships, see link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship[How to remove a load-sharing mirror relationship].
...
// 2026-Sept-21, GitHub issue #2133
// 2025 Sept 23, ONTAPDOC-3360

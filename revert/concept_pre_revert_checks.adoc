...
| ONTAP 9.18.1
a|
* If automatic enablement has been set for ARP as part of an ONTAP 9.18.1 upgrade, you'll need to link:anti-ransomware-disable-auto-enable.html[disable it].

...
* You should have completed the pre-revert link:task_things_to_verify_before_revert.html[verifications].
* You should have completed the ONTAP version specific revert link:concept_pre_revert_checks.html[pre-checks].

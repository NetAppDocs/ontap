...
You must have completed the revert link:task_things_to_verify_before_downgrade_revert[verifications] and link:concept_pre_downgrade_revert_checks.html[pre-checks].

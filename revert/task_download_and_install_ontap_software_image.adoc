...
[source,cli]
----
system node image update -node * -package http://example.com/downloads/image.tgz -replace-package true -replace image1/2 -background true -setdefault true 
----
+
...
[source,cli]
----
system node image update -node * -package http://example.com/downloads/image.tgz -replace-package true -replace image1/2 -background true -setdefault false
----
+

...
You can access the setting `ext_performance_monitoring.enabled` at the endpoint `/api/storage/qtrees`. The POST and PATCH methods are available depending on whether you are creating a new qtree or configuring an existing qtree.

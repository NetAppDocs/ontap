...
+
link:https://docs.netapp.com/us-en/ontap-afx/administer/revert-ontap.html[AFX storage systems^] do not support reversion. 
...
* If you have NFS over TLS enabled in ONTAP 9.19.1 or later, you must disable all NFS over TLS configuration instances before you can revert to an earlier version of ONTAP. NFS over TLS is only supported beginning with ONTAP 9.19.1.

// 2026 Jul 7, ONTAPDOC-3879
// 2025 Dec 09, ONTAPDOC-3485

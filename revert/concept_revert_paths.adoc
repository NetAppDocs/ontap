...
[NOTE]
link:https://docs.netapp.com/us-en/ontap-afx/administer/revert-ontap.html[AFX storage systems^] do not support reverting ONTAP software. 

[cols=2*,options="header"]
|===
| You can revert from...| To...

a| ONTAP 9.19.1 | ONTAP 9.18.1
a| ONTAP 9.18.1 | ONTAP 9.17.1

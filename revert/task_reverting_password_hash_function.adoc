...
. Set a temporary password for each SHA-2 user account that you xref:revert/identify-user-sha2-hash-user-accounts.html[identified prior to reverting]: `security login password -username user_name -vserver vserver_name`

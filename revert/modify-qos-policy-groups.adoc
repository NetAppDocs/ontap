...
summary: "If you have modified the default settings on any QoS policy group created in ONTAP 9.19.1 or later, you must reset them before you can revert from ONTAP 9.19.1 to ONTAP 9.18.1."
---

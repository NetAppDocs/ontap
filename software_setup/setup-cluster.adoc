...
Support for IPv6 configuration during cluster setup varies based upon your version of ONTAP and your platforms.  

[cols="2,2,4a" options="header"]
|===
|ONTAP Version
|Platform
|Configuring IPv6 during cluster setup is...

|ONTAP 9.13.1 and later
a|
* AFF 8700
* FAS 8700
|Supported using the ONTAP CLI 

|ONTAP 9.13.1 and later 
|Any platform other than the AFF 8700 or FAS 8700
|Not supported during cluster setup
...
If IPv6 is not supported during cluster setup for your ONTAP version or platform, you should use System Manager to create your cluster using IPv4; then link:convert-ipv4-to-ipv6-task.html[convert to IPv6] after cluster setup is complete.

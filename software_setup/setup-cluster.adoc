...
Assignment of IPv6 addresses to management LIFs during cluster setup is supported on the following systems and ONTAP versions.

[cols="2", options="header"]
|===
| ONTAP Version | Supported Systems
| 9.17.1 and later
a| 
* AFF C60
* AFF C30
...
Your BMC version must be 19.3 or later to support IPv6 address assignment during cluster setup.
...
You must perform cluster setup with the ONTAP CLI to assign IPv6 addresses on the supported systems. If assignment of IPv6 addresses during cluster setup is not supported on your system and ONTAP version,  you should use System Manager to create your cluster using IPv4 addresses, and then link:convert-ipv4-to-ipv6-task.html[convert to IPv6] addresses after you complete cluster setup.
...
* You should have installed, cabled and powered on your new storage system according to the installation and set up instructions for your system model.
+

...
a|
xref:software_setup/task_configuring_important_ems_events_to_send_email_notifications.html[Configuring important EMS events to send email notifications]
a|
The EMS to forward important event notifications to a syslog server
a|
xref:software_setup/task_configuring_important_ems_events_to_forward_notifications_to_a_syslog_server.html[Configuring important EMS events to forward notifications to a syslog server]
a|
If you want the EMS to forward event notifications to an SNMP traphost
a|
xref:software_setup/task_configuring_snmp_traphosts_to_receive_event_notifications.html[Configuring SNMP traphosts to receive event notifications]
|===

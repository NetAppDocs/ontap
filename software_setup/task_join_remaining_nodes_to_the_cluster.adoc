...
*Best Practice:* If you have a FAS2720 with 24 or less NL-SAS drives, to optimize performance you should verify that the storage configuration default is set to active/passive.

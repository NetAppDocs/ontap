...
Beginning with ONTAP 9.18.1, you can configure encrypted communication between HA pair nodes. For more information, refer to:link:ha-pair-encryption.html[Configure encryption communication between ONTAP HA pair nodes].

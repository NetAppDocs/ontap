...
For details on all `storage failover modify` parameters, see the link:https://docs.netapp.com/us-en/ontap-cli-9131/storage-failover-modify.html[ONTAP manual pages].

...
* Before enabling HA traffic encryption, you must link:../encryption-at-rest/configure-external-key-management-concept.html[Configure external key management].

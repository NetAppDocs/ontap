...
This procedure creates new volumes on an link:task_nas_enable_linux_nfs.html[existing NFS-enabled storage VM]. You can accept system defaults when configuring volumes or specify customer configurations.

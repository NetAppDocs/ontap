...
. [[step2,Step 2 in the workflow]] On a Linux client, do the following to verify access.
...
NOTE: After you save the volume, return to <<step2>> to complete provisioning for Linux servers using NFS.
...
| System Manager Classic (ONTAP 9.7 and earlier | link:https://docs.netapp.com/us-en/ontap-sm-classic/nfs-config/index.html[NFS configuration overview^]

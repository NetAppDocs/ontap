...
= Provision NFS storage for Linux servers with ONTAP System Manager
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
You can create FlexVol volumes, or for large file systems with high performance requirements, you can create FlexGroup volumes.  See also link:./flexgroup/create-task.html[Create FlexGroup volumes].

---
permalink: upgrade_new/task_identifying_current_cluster_activity.html
...
[.lead]
Before upgrading, no jobs should be running and any  CIFS sessions that are not continuously available should be terminated.
...
Before performing a nondisruptive upgrade, you should identify and gracefully terminate any CIFS sessions that are not continuously available.

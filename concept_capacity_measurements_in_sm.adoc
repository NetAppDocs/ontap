...
link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-vsmg/GUID-65C34C6C-29A0-4DB7-A2EE-019BA8EB8A83.html["Logical space reporting and enforcement for volumes"] topic in the link:link:../volumes/index.html[ONTAP 9 Logical Storage Management Guide]

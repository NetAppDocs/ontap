...
. Complete the *Map Network Drive* dialog box:
 ...
 .. In the *Folder* box, type the IP address or CIFS server name of the storage virtual machine (SVM) containing the share that holds both the data you would like to audit and the name of the share.
+

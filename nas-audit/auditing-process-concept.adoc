...
For more information about command history audit logs, see the "Managing audit logging for management activities" section in https://docs.netapp.com/us-en/ontap/system-admin/index.html[System administration].

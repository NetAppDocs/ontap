...
---
= Supported FPolicy file operations and filters for NFSv4 in ONTAP
:icons: font
:imagesdir: ../media/
...
Beginning with ONTAP 9.19.1, administrators can control NFSv4.2 availability at the SVM level, enabling or disabling the protocol for individual storage VMs using either System Manager, the CLI, or REST API. 

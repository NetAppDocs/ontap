...
For more information, refer to link:persistent-stores.html[FPolicy persistent stores][FPolicy persistent stores] and link:create-persistent-stores.html[Create persistent stores].

...
. Click image:icon_kabob.gif[Menu Options] next to the source volume you want to restore to display the menu, and select *Restore*.
...
. Click image:icon_kabob.gif[Menu Options] next to the source volume and select *Delete*.
...
. Select the object store you want to delete, click image:icon_kabob.gif[Menu Options] and select *Delete*.

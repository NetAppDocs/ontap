...
summary: Starting in ONTAP 9.9.1, you can use System Manager to back up your data to the cloud and to restore your data from cloud storage to a different volume. You can use either StorageGRID or ONTAP S3 as your cloud object store.
---
...
[.lead]
Starting in ONTAP 9.9.1, you can back up your data to the cloud and to restore your data from cloud storage to a different volume by using System Manager. You can use either StorageGRID or ONTAP S3 as your cloud object store.

Before using the SnapMirror Cloud feature, you should generate a SnapMirror Cloud API license key on the NetApp Support Site: link:https://mysupport.netapp.com/site/tools/snapmirror-cloud-api-key[Generate SnapMirror Cloud API license key]
...
.Steps
// BURT 1418445 correction in workflow, thomi 10 SEP 2021

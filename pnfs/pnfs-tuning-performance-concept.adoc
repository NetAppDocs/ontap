...
[.lead]
When using pNFS in NetApp ONTAP, use these considerations and best practices for best results. 

//For questions or suggestions, contact NetApp at doccomments@netapp.com and include TECHNICAL REPORT 4063 BEST PRACTICES in the subject line.
...
link:../nfs-admin/specify-nfsv4-id-domain-task.html[Learn about specifying the NFSv4 ID domain]
...
link:../nfs-admin/ontap-support-nfsv40-concept.html[Learn about ONTAP support for NFSv4.0]

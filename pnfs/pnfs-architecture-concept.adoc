...
image::pNFS_fig_007.png[Establish the metadata server in pNFS in ONTAP]
...
NOTE: In these commands, the volume names are not present. Instead, the numeric IDs associated with those volumes are used: the MSID and the DSID. To find the volumes associated with the mappings, you can use `volume show -dsid [dsid_numeric]` or `volume show -msid [msid_numeric]` in advanced privilege of the ONTAP CLI.
...
* https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf[NetApp Technical Report 4571: FlexGroup Best Practices^]

// 2025-10-21, ONTAPDOC-2826
// ONTAPDOC-4250, 2026-AUG-27
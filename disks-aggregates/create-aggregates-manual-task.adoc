...
Learn more about `storage aggregate create` and aggregate creation options and requirements in the link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-create.html[ONTAP command reference^].

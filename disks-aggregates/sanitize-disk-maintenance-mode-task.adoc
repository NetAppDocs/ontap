...
The specified disks sanitization logs that show the overall process of what was completed on each disk is written to `/mroot/etc/log/sanitization.log`.

// 2022-01-18, BURT 1425677
// 2022-05-02, issue #481
// 2022-08-10, issue #621
// 2022-09-11, BURT 1485072
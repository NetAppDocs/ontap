...
* For more information about and implications of converting between RAID types, refer to the https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-modify.html#parameters[parameters for the `storage aggregate modify` command].

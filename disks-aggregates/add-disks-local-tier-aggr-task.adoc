...
[%collapsible]
====
Using System Manager with ONTAP 9.7 or earlier, you can add capacity to a local tier (aggregate) by adding capacity disks.
...
You perform this task only if you have installed ONTAP 9.8 or later.  If you installed an earlier version of ONTAP, refer to <<increase-cap-97-earlier,Use System Manager to add capacity (ONTAP 9.7 or earlier)>>.

...
[NOTE]
With ONTAP 9.15.1, two new metadata counters have been added. Together with changes to several existing counters, you can get a clearer view of the amount of user data allocated. See link:../volumes/determine-space-usage-volume-aggregate-concept.html[Determine space usage in a volume or aggregate] for more information.

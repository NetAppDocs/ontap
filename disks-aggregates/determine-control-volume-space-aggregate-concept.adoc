...
The procedure you follow depends on the interface you use:
...
--
*Use System Manager to determine and control a volume's space usage in a local tier*
...
--
*Use the CLI to determine and control a volume's space usage in an aggregate*

...
The minimum number of HDDs you should add in a single procedure is six. The minimum number of SSDs you should add in a single procedure is three.  Adding a single drive might reduce performance.

...
* *link:prepare-add-local-tiers-overview-task.html[Prepare to add a local tier (aggregate)]*
+
...
* *link:add-capacity-local-tier-overview.html[Add capacity (disks) to a local tier (aggregate)]*
+

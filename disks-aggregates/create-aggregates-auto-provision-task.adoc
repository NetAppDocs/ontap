...
The https://docs.netapp.com/us-en/ontap-cli-9141//storage-aggregate-auto-provision.html[`storage aggregate auto-provision` man page^] contains more information about the aggregate layout recommendations.

...
summary: "If adding SSDs to a storage pool causes your platform model’s cache limit to be exceeded, ONTAP does not allocate the newly added capacity to any Flash Pool aggregates. This can result in some or all of the newly added capacity being unavailable for use."
---

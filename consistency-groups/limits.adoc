...
| Number of volumes in a consistency group with asynchronous SnapMirror | Single consistency group | 1 volume 
a| 
...
{asterisk} A maximum of 50 consistency groups enabled with asynchronous SnapMirror can be hosted on a cluster. 

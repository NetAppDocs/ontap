...
include::../_include/consistency-group-snapshot-minimum.adoc[] This recommendation is based on link:https://www.netapp.com/media/12385-tr4571.pdf[testing for FlexGroups^], which share the same Snapshot infrastructure as consistency groups

...
[.lead]
Consistency groups can be created with new or existing volumes. Once a volume is associated with a consistency group, it cannot be added with another consistency group.
...
To create a consistency group for existing volumes, follow these steps. 

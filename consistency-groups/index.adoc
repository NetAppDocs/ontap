...
[NOTE]
In ONTAP 9.13.1, you can only retrieve historical metrics using the REST API. Beginning in in ONTAP 9.14.1, historical metrics are also available in System Manager. 

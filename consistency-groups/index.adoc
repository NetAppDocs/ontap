...
You can apply tags when creating consistency groups or after the consistency groups have been created. If the consistency group has an SM-BC relationship, you must use *Other* as the application or component tag. Beginning in ONTAP 9.14.1, you can modify the application or component tags using the ONTAP CLI. 

...
Volumes associated with consistency groups can be moved between mirrored and unmirrored aggregates, after they are provisioned, so they can be located on mirrored aggregates, unmirrored aggregates, or both.

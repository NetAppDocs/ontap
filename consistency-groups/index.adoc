...
Beginning in ONTAP 9.11.1, there is added support for consistency group protection with link:link:protect-task.html#two-phase-commits[two-phase commits]. 

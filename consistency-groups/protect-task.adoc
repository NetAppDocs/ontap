...
summary: "Use consistency groups to protect data using local Snapshots, SnapMirror asynchronous, SM-BC, and SVM disaster recovery." 
---
...
Consistency groups offer remote protection through SM-BC and, Beginning with ONTAP 9.13.1, SnapMirror asynchronous.

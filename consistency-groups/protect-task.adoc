...
[NOTE]
If you initiate the Snapshot creation in the ONTAP CLI, you must commit the Snapshot with the CLI. If you initiate the Snapshot creation in the API, you must commit the Snapshot in the API. Mixed methods are not supported. 

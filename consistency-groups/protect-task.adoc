...
Beginning in ONTAP 9.14.1, xref:../data-protection/snapmirror-svm-replication-concept.html#[SVM disaster recovery] supports consistency groups, mirroring consistency group information from the source to the destination cluster. 

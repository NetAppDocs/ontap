...
summary: "Use consistency groups to protect data using local Snapshots, Asynchronous SnapMirror, SnapMirror active sync, and SVM disaster recovery." 
---
...
Consistency groups offer remote protection through SnapMirror active sync and, beginning with ONTAP 9.13.1, asynchronous SnapMirror.
...
. Ensure you have met the link:../smbc/smbc_plan_prerequisites.html[prerequisites for using SnapMirror active sync].
. Select *Storage > Consistency groups*.
. Select the consistency group you have created from the Consistency group menu.
...
* link:../smbc/index.html[SnapMirror active sync overview]

...
.Steps
. Navigate to the *Consistency Group* tab in System Manager. Select the consistency group that you want to modify to view the volumes associated with that consistency group. 

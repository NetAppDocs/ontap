...
* When expanding a consistency group, Snapshot copies of the consistency group captured before the modification will be considered partial. Any restore operation based on that snapshot will reflect the consistency group at the point-in-time of the snapshot.

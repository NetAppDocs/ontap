...
If these assumptions are not correct for your situation, you should see https://docs.netapp.com/us-en/ontap/tape-backup/index.html[Data protection using tape backup]

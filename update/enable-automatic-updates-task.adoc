...
+
*Automatically update* is selected for all options by default. You can choose to modify the default selection to *Show notifications* or *Automatically dismiss the updates*.

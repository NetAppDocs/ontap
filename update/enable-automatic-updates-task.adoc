...
Enabling automatic updates requires that you accept the terms of a EULA and confirm or configure the default update behavior for each component as appropriate for your environment.

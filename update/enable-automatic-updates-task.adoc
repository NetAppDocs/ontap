...
Automatic update defaults are set to either update automatically or show notifications, depending on your ONTAP version. Confirm these settings are correct for your environment before completing the procedure. 

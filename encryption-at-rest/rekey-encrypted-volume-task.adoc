...
summary: "It is a security best practice to change the encryption key for a volume periodically. Starting with ONTAP 9.3, you can use the volume encryption rekey start command to change the encryption key."
---

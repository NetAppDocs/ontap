...
For additional information, refer to the `security key-manager external` page in the link:https://docs.netapp.com/ontap-9/topic/com.netapp.nav.cr/home.html[ONTAP command reference^].

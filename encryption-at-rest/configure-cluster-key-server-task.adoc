...
* Learn more about `security key-manager external` in the link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=security+key-manager+external[ONTAP command reference^]

// 2025 Dec 09, ONTAPDOC-3467

...
For additional information, refer to the `security key-manager external` page in the link:https://docs.netapp.com/us-en/ontap-cli-9131/[ONTAP command reference^].

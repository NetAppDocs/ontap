...
You can use NetApp Volume Encryption with hardware-based encryption to "`double encrypt`" data on self-encrypting drives. When self-encrypting drives are enabled, the core dump is also encrypted.

...
[NOTE]
====
* The timeout value is expressed in seconds.  If you specify 0, there is no timeout and the connection request can wait indefinitely. If you specify any value in the range 1-60, the connection request waits for the specified number of seconds before timing out.

...
[.lead]
Change the Onboard Key Manager passphrase regularly. You must store the new passphrase in a secure location outside the storage system.
...
+
The command you use depend on the ONTAP version you are running.
+
[role="tabbed-block"]
====

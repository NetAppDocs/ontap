...
* If you are in a MetroCluster environment, after you update the passphrase on the local cluster, you synchronize the passphrase update on the partner cluster.

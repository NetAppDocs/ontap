...
* You must enter the current onboard key management passphrase before you can set a new passphrase.
...
+
After you enter the command, respond to the prompts to enter the current passphrase, the new passphrase, and the new passphrase again for confirmation.
+
[role="tabbed-block"]
====
...
. When prompted, enter the current passphrase.
. Enter a new passphrase between 32 and 256 characters, or for "`cc-mode`", a passphrase between 64 and 256 characters.
+
...
. At the passphrase confirmation prompt, reenter the new passphrase.

...
* In ONTAP 9.4 and earlier, after you run `security key-manager update-passphrase` on the local cluster, wait 20 seconds, and then run the following command on the partner cluster:
+

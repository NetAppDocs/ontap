...
+
Learn more about the link:https://docs.netapp.com/us-en/ontap-cli/volume-encryption-conversion-start.html[`volume encryption conversion start`^] command in the ONTAP command reference.
+
...
+
Learn more about the link:https://docs.netapp.com/us-en/ontap-cli//volume-show.html#parameters[`volume show -is-encrypted true`^] command in the ONTAP command reference.
+

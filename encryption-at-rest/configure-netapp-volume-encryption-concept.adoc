...
SVM scope
a|
MetroCluster is supported beginning with ONTAP 9.8.

Beginning with ONTAP 9.6, NVE supports SVM scope for external key management only, not for Onboard Key Manager.
a|
Storage efficiency
a|

...
NOTE: Cloud KMS providers such as Azure Key Vault and AWS KMS are supported with ONTAP 9.10.1 and later. These providers do not support KMIP and, as a result, are not listed on IMT.

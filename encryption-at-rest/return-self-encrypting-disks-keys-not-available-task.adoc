...
Verify the operation succeeded with the command `storage encryption disk show-status` before proceeding to the next step.
 .. If you are running ONTAP 9.8P6 or later, unfail the sanitized disk. If you are running ONTAP 9.8P5 or earlier, skip to the next step. 
...
For complete command syntax, see the link:https://docs.netapp.com/us-en/ontap-cli-9141/storage-disk-assign.html[command reference^].

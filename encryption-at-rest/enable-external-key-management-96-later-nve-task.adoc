...
[.lead]
You can use one or more KMIP servers to secure the keys the cluster uses to access encrypted data. Beginning with ONTAP 9.6, you can configure an external key manager to secure the keys that a data SVM uses to access encrypted data.

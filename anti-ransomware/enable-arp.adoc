...
keywords: ARP, enable, autonomous ransomware protection, ONTAP 9.10.1, NAS, FlexVol, FlexGroup, learning mode, dry-run, ransomware
summary: "Beginning with ONTAP 9.10.1, enable ARP on existing or new NAS volumes to start ransomware detection in learning mode."
---

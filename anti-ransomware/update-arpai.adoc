...
NOTE: ARP (ONTAP 9.10.1–9.15.1) does not support automatic security model updates. Security detection capabilities are updated only with ONTAP software upgrades. If you are running ONTAP 9.15.1 or earlier, see link:index.html[Learn about Autonomous Ransomware Protection].

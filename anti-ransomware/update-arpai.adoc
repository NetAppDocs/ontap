...
keywords: ARP/AI, update, autonomous ransomware protection AI, security files, security package, security updates, security bundle, automatic update, manual update, ONTAP 9.16.1, machine learning ransomware
summary: "Keep ARP/AI protection up to date against the latest ransomware threats by automatically or manually updating security bundles."
---

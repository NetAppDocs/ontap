...
keywords: ARP/AI, update, autonomous ransomware protection AI, security files, security package, security updates, security bundle, automatic update, manual update, ONTAP 9.16.1, machine learning ransomware, update ransomware model ONTAP, ARP/AI security bundle update, automatic ransomware security updates
summary: "Keep ARP/AI protection up to date against the latest ransomware threats by automatically or manually updating ARP/AI security bundles independent of ONTAP release cadence."
---
...
NOTE: ARP (ONTAP 9.10.1 to 9.15.1) does not support automatic security model updates. Security detection capabilities are updated only with ONTAP software upgrades. If you are running ONTAP 9.15.1 or earlier, see link:index.html[Learn about Autonomous Ransomware Protection].
...
NOTE: Be sure to install only a more recent ARP/AI update than your current version to avoid any unintended ARP/AI downgrades.
...
// 2026-06-30, restructured from arp-ai-automatic-updates.adoc

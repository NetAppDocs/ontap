...
New volumes are created with ARP disabled by default. You must first enable anti-ransomware functionality so that ARP will be enabled by default on new volumes created in the SVM.
...
* Volume capacity at less than 100%.

...
NOTE: Beginning with ONTAP 9.18.1, ARP is enabled by default on all new volumes for link:use-cases-restrictions-concept.html#supported-configurations[supported systems] after a 12-hour grace period following a cluster upgrade or new installation. For ONTAP 9.18.1 and later, you won't need to configure SVM for ARP enablement.

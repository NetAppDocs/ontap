...
New volumes are created with ARP functionality disabled by default. You'll need to enable ARP functionality and set it to be enabled by default on new volumes created in the SVM.

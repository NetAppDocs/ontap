...
* *For ARP 9.10.1 to 9.15.1 and ARP with FlexGroup volumes* 
...
* *For ARP/AI 9.16.1 and later with FlexVol volumes*
ARP is automatically enabled in active mode by default for new FlexVol volumes and no learning period is required.

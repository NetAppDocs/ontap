...
While ONTAP includes features like FPolicy, Snapshot copies, SnapLock, and Digital Advisor to help protect from ransomware, the following information focuses on the ARP on-box feature with machine learning capabilities.

...
== Choose your documentation according to your ARP model
...
* *link:learn-about-arp.html[ARP]* — ONTAP 9.10.1 to 9.15.1: NAS-focused model with a learning period before active protection begins. Also applies to FlexGroup volumes on ONTAP 9.16.1 and 9.17.1.

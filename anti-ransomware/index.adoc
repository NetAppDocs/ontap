...
Learning and active modes are used for NAS environments. For ARP/AI running in NAS environments beginning in ONTAP 9.16.1, there is no learning period when ARP is used with FlexVol volumes.
...
|===
| Mode | Description | Versions and volume types
| Learning 

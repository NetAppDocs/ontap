...
Beginning with ONTAP 9.16.1, ARP improves cyber resiliency by adopting a machine-learning model for anti-ransomware analytics that detects ever-evolving forms of ransomware with 99% accuracy. ARP's pre-trained machine-learning model is trained on a large dataset of files both before and after a simulated ransomware attack. This resource-intensive training is done outside ONTAP, but the learning from this training is used for a pre-trained model inside ONTAP. 

With ARP/AI, there is no learning period. ARP/AI begins in active mode immediately after installation or upgrade to 9.16. link:enable-arp-ai-with-au.html[Learn more].

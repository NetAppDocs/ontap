...
== Choose your documentation by model

Autonomous Ransomware Protection includes two models. Select the documentation for your ONTAP version:
...
* *link:learn-about-arp.html[ARP]* — ONTAP 9.10.1 to 9.15.1: NAS-focused model with a learning period before active protection begins.

NOTE: The original ARP model received no new functional improvements after ONTAP 9.14.1. If you are running ONTAP 9.16.1 or later, use the ARP/AI documentation.

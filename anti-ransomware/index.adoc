...
ARP requires a license. ARP is available with the link:../os/ONTAP_9.10.1_and_later_licensing_overview[ONTAP ONE license^]. If you do not have the the ONTAP One license, other licenses are available to use ARP, which differ depending on your version of ONTAP. 

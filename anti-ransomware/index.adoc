...
You'll need a license to be able to use ARP. You'll also need to consider if you want ARP enabled by default in new volumes or if you want to manually enable it on a per-volume basis.

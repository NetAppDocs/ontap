...
This default ARP enablement does not apply to link:use-cases-restrictions-concept.html#unsupported-configurations[unsupported volumes or configurations].

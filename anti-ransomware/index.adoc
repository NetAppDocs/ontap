...
In a low threat situation, ONTAP detects an abnormality and creates a Snapshot of the volume to create the best possible recovery point. The ARP Snapshot uses the `anti-ransomware-backup` tag and is identifiable by its name, for example `Anti_ransomware_backup.2022-12-20_1248`. 

...
* The anti-ransomware feature is available for all on-premises ONTAP systems beginning with ONTAP 9.10.1, but it is not currently available in Cloud Volumes ONTAP environments.

...
^1^ ONTAP 9.16.1 to 9.17.1 do not provide ARP/AI support FlexGroup volumes. After an upgrade to these versions, FlexGroup volumes enabled for ARP continue to operate with the same ARP model used prior to ARP/AI. Beginning in ONTAP 9.18.1, FlexGroup volumes use the ARP/AI model.

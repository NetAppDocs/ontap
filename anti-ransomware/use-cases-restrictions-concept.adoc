...
* After upgrading to ONTAP 9.19.1 RC and enabling ARP on volumes that are part of SnapMirror synchronous or SnapMirror active sync relationships, the relationship might experience a brief Out‑of‑Sync state. This condition is temporary, and the relationship should automatically resynchronize without any intervention.

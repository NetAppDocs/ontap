...
[[arp-sm-oos-after-upgrade]]

NOTE: After upgrading to ONTAP 9.19.1 RC and enabling ARP on volumes that are part of SnapMirror synchronous or SnapMirror active sync relationships, the relationship might briefly move to an out-of-sync state. This condition is temporary, and the relationship should automatically resynchronize without any intervention.

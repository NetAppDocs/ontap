...
* Asynchronous SnapMirror (Unsupported only in ONTAP 9.10.1 through 9.12.1. Asynchronous SnapMirror is supported beginning with ONTAP 9.12.1. For more information, see <<snapmirror>>.)
* Restricted volumes

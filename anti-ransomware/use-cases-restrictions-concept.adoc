...
summary: ARP is supported for NAS workloads and is particularly well suited for databases on NFS storage, Windows or Linux home directories, and video and image workloads. 
---

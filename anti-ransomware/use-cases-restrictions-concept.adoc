...
ARP is available for NFS and SMB FlexVol volumes in on-premises ONTAP systems beginning with ONTAP 9.10.1. Beginning in 9.17.1, ARP is also available for SAN FlexVol volumes with LUNs or VDMKs.

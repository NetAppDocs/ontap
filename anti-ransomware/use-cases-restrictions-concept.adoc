...
Beginning with ONTAP 9.12.1, ARP is supported on SnapMirror asynchronous destination volumes. ARP is _not_ supported with SnapMirror synchronous or SnapMirror active sync in ONTAP 9.18.1 and earlier.

...
*ARP/AI does not support FlexGroup volumes. FlexGroup volumes enabled for ARP continue to operate after upgrading to ONTAP 9.16.1 using the ARP model used in ONTAP 9.15.1 and earlier.

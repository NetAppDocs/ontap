...
* `Anti_ransomware_backup`: Used in ONTAP 9.16.1 and earlier (Example: `Anti_ransomware_backup.2022-12-20_1248`) with snapshots that are created in response to abnormalities.
* Anti_ransomware_periodic_backup": Used in ONTAP 9.17.1 and later (Example: `Anti_ransomware_periodic_backup.2025-06-01_1248`) for snapshots created at regular intervals.

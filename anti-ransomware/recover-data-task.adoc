...
* *Single-file SnapRestore*: Restores individual files from snapshots. Each file can be sourced from a different snapshot. Practical when the number of affected files is relatively small (tens to hundreds of files).
+

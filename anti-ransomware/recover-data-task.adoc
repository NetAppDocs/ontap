...
+
NOTE: It is only necessary to release the anti-ransomware Snaplock before restoring from earlier snapshot copies if you are using the `volume snap restore` command as outlined below. If you are restoring data using FlexClone, Single File Snap Restore, or other methods, this is not necessary.
+

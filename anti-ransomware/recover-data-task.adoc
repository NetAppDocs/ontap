...
* You'll also want to choose a <<choose-a-recovery-method,restore method>> and <<recovery-constraints-and-considerations,learn about recovery considerations and constraints>> before you completing a restore procedure. 

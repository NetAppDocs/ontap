...
. If the volume is part of a SnapMirror synchronous or SnapMirror active sync SAN relationship in ONTAP 9.19.1 RC and you intend to perform a volume-level restore with `volume snapshot restore`, quiesce or break the SnapMirror synchronous or SnapMirror active sync relationship according to SnapMirror synchronous or SnapMirror active sync documentation before running the restore operation.

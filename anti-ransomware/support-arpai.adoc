...
keywords: ARP/AI, autonomous ransomware protection AI, ONTAP 9.16.1, supported configurations, SAN ransomware, NAS ransomware, machine learning ransomware, hypervisor ransomware, SnapMirror ARP, AFF ransomware protection, ASA ransomware, FlexVol ARP, FlexGroup ARP
summary: "ARP/AI (ONTAP 9.16.1 and later) supports NAS and SAN workloads across FlexVol and FlexGroup volumes on AFF, ASA, FAS, and ASA r2 systems."
---

...
summary: "When legacy ARP in ONTAP 9.10.1 through 9.15.1 detects abnormal activity in a protected NAS volume, evaluate whether it is a false positive or a real ransomware attack and respond accordingly."
---

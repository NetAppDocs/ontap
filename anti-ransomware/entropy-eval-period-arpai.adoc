...
summary: "Beginning with ONTAP 9.17.1, ARP/AI requires an evaluation period to determine if block-device entropy levels are suitable for ransomware protection."
---
...
* link:modify-snapshot-options-arpai.html[Modify snapshot options for ARP/AI]

...
Beginning with ONTAP 9.19.1 RC, ARP/AI snapshots created for volumes that participate in SnapMirror synchronous or SnapMirror active sync relationships follow these additional rules:

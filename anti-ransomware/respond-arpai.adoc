...
In the case of a suspected attack, you must determine whether it is an attack, respond to it if it is, and then clear notices and restore data. link:recover-arpai.html[Learn more about how to recover from a ransomware attack].

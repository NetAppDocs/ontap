...
NOTE: For ONTAP 9.13.1 to 9.17.1, FlexGroup volumes use the earlier ARP model and require a learning period. See link:enable-arp.html#enable-arp-on-nas-flexgroup-volumes[Enable ARP on NAS FlexGroup volumes].

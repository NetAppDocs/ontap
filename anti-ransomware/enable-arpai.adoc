...
keywords: ARP/AI, enable, autonomous ransomware protection AI, ONTAP 9.16.1, NAS, SAN, FlexVol, FlexGroup, machine learning ransomware, active mode
summary: "Beginning with ONTAP 9.16.1, enable ARP/AI on NAS FlexVol volumes with immediate active protection and no learning period. SAN and FlexGroup support is available in later releases."
---
...
To enable ARP/AI, follow the procedure that matches your environment after you ensure that your environment meets the requirements:
...
Beginning with ONTAP 9.16.1, ARP/AI is active immediately with no learning period required for NAS FlexVol volumes.

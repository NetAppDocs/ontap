...
. Record your response to the abnormal activity:
+
[cols="25,75"]
|===
...
a| Potential Ransomware Attack a| . Classify the activity and proceed with recovery:
...
+
After classifying the activity, link:recover-data-task.html[restore the protected data].

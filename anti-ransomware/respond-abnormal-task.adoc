...
+
This action clears warning notices about suspected files. ARP then resumes normal monitoring of the volume. ARP snapshots cannot be deleted until the end of the retention period.
...
This action clears the attack report. ARP snapshots cannot be deleted until the end of the retention period. There are no suspected file type notices to clear if you restored an entire volume.
|===
--
...
+
The `clear-suspect` operation clears the warning notices and ARP resumes normal monitoring of the volume. ARP snapshots cannot be deleted until the end of the retention period. There are no suspect file types to clear if you restored an entire volume.
...
* `[-start-time <date_time> -end-time <date_time>]`: Starting and ending times for the range of files to be cleared, in the form "MM/DD/YYYY HH:MM:SS".
+
This `clear-suspect` operation clears the attack report. ARP snapshots cannot be deleted until the end of the retention period. There are no suspect file types to clear if you restored an entire volume.

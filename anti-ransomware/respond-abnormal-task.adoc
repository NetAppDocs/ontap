...
. Before you recover data, you should consider your link:recover-data-task.html#choose-a-recovery-method[recovery method options]. Then do one of the following:
...
... Recover data by using link:recover-data-task.html[FlexClone or single-file SnapRestore].

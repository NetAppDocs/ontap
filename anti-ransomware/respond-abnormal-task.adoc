...
After you categorize an attack, ARP snapshots are either retained for an abbreviated period initiated by the categorization operation (ONTAP 9.16.1 and later), or deleted instantly (ONTAP 9.15.1 and earlier).

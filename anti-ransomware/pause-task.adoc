...
+
NOTE: Beginning with ONTAP 9.13.1, if you are using MAV to protect your ARP settings, the pause operation prompts you to obtain the verification of one or more additional administrators. Verification must be received from the all administrators associated with the MAV approval group or the operation will fail.

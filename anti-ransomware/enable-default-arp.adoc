...
NOTE: For ONTAP 9.13.1 to 9.17.1, FlexGroup volumes use the earlier ARP model and require a learning period. Use this procedure for FlexGroup volumes running ONTAP 9.17.1 and earlier.

...
summary: The original ARP model uses a learning period to establish behavioral baselines before switching to active ransomware detection. Applies to NAS FlexVol volumes in ONTAP 9.10.1 to 9.15.1 and FlexGroup volumes in ONTAP 9.13.1 to 9.17.1.
---

= Learn about ARP (original model)
:hardbreaks:
:toclevels: 1
:nofooter:
:icons: font

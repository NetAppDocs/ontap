...
* *ONTAP 9.16.1+ (NAS FlexVol)* and *9.18.1+ (NAS FlexGroup)*: ARP/AI is active immediately with no learning period
* *ONTAP 9.10.1-9.15.1 (NAS FlexVol)* and *9.10.1-9.17.1 (NAS FlexGroup)*: Starts in learning mode for 30 days
* *ONTAP 9.17.1+ (SAN)*: Enters evaluation period to establish baseline
====

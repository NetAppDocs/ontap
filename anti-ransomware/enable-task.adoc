...
* (Recommended) An EMS system configured to send email notifications for ARP activity. See link:../error-messages/configure-ems-events-send-email-task.html[Configure EMS events to send email notifications].

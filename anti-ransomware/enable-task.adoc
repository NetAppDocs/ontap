...
* *(NAS environments only) For ONTAP 9.10.1 to 9.15.1 and ARP with FlexGroup volumes* 
...
** SAN: iSCSI
+
NOTE: For SAN, you'll also need to connect via iSCSI to a attached LUN on a machine that's using iSCSI protocol.

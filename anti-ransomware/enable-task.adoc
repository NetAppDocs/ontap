...
For ARP 9.10.1 to 9.15.1, you first enable ARP in learning mode, in which the system analyzes the workload to characterize normal behavior. For ARP/AI 9.16.1, ARP is enabled automatically in active mode and no learning period is required.

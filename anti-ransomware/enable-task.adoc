...
To enable ARP, follow the procedure that matches your environment after ensuring that your environment meets certain requirements:

* <<enable-nas-flexvol,NAS with FlexVol volumes>>
* <<enable-nas-flexgroup,NAS with FlexGroup volumes>>
* <<enable-san,SAN volumes>>

Enablement and activation differ based on your environment and ONTAP version:

[cols="25,25,50",options="header"]
|===
| Volume type | ONTAP version | Enablement behavior
...
[source, cli]
----
security anti-ransomware volume enabled -volume <vol_name> -vserver <svm_name>
----

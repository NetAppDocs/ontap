...
* SAN workloads.
+
ARP (9.10.1 to 9.15.1) does not support SAN volumes. SAN support was introduced with ARP/AI in ONTAP 9.17.1. link:learn-about-arpai.html[See ARP/AI documentation for more information about SAN.]

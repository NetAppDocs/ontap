...
Select *Storage > storage VMs,* then select the storage VM, then *Settings*. Finally, select image:icon_pencil.gif[edit icon] under *S3*.
+
...
.. Select image:../media/icon_arrow.gif[right arrow] next to *Protection Policies*, then click *Add*.

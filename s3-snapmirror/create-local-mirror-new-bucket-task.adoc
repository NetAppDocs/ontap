...
summary: When you create new S3 buckets, you can protect them immediately to an SnapMirror S3 destination on the same cluster. You can mirror data to a bucket in a different storage VM or the same storage VM as the source.
---

...
.. In the *Permissions* tab, click image:icon_pencil.gif[edit icon] *Edit*, then click *Add* under *Permissions*. Make sure the following values are shown:
...
.. In the *SnapMirror (ONTAP or Cloud)* tab, click image:icon_kabob.gif[more icon] *More*, then click *Protect*. Enter the following values:
* Destination
** *TARGET*: ONTAP System

...
** *STClick Protect and enter the following valuesORAGE VM*: Select the same or a different storage VM.
...
----
+
. Install CA server certificates for the source and destination SVMs:

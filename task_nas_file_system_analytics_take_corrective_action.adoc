...
In the Explorer display, you can select directories or individual files to delete. Directories are deleted with low-latency asynchronous directory delete functionality. (Asynchronous directory delete is also available beginning in ONTAP 9.9.1 without analytics enabled.)

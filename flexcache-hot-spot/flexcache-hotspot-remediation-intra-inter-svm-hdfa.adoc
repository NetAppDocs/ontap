...
.What's next
Now that you have an idea of how you want to deploy your HDFAs, link:flexcache-hot-spot/flexcache-hotspot-remediation-ontap-config.html[deploy the HDFA and configure the clients to access them in a distributed fashion].

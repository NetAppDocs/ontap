...
Beginning with ONTAP 9.12.1, for users who are registered with Active IQ Digital Advisor, System Manager displays another column of results that provide links to NetApp Support Site information, including System Manager product information.  

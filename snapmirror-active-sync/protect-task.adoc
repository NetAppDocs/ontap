...
+
`SiteA::> igroup create -vserver _svm_name_  -os-type _os_type_ -igroup _igroup_name_ -replication-peer _peer_svm_name_ -initiators _host_`
+
`SiteA::> igroup add -vserver _svm_name_ -igroup _igroup_name_  -os-type _os_type_ -initiators _host_`

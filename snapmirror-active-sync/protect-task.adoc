...
== Configure active/active symmetric protection 
...
--
.Steps for a uniform configuration 
. Create a new SnapMirror relationship grouping all the volumes in the application. Ensure you desginate the `AutomatedFailOverDuplex`" policy to establish bidirectional sync replication.
+

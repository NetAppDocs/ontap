...
* Beginning with ONTAP 9.16.1 GA, SnapMirror active sync supports symmetric active/active configurations on 4-node clusters. 
** To use SnapMirror active sync on a 4-node cluster, you must be running ONTAP 9.16.1 GA or later.

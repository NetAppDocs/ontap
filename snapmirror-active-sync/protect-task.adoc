...
= Protect with ONTAP SnapMirror active sync for SAN
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
Configuring asymmetric protection for SAN configurations using SnapMirror active sync involves selecting LUNs on the ONTAP source cluster and adding them to a consistency group. 
...
* The source and destination cluster cannot be part of a MetroCluster configuration.
...
You can establish symmetric protection for SAN configurations by using System Manager or the ONTAP CLI. In both interfaces, there are different steps for xref:index.html#key-concepts[uniform and non-uniform configurations]. 
...
// 2026 July 30, ONTAPDOC-4133
// 2026-May-24, ONTAPDOC-3544
// 2025-Oct-29, ONTAPDOC-3438

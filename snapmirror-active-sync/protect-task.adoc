...
.Before you begin
You should be aware of the supported and unsupported configurations with NVMe namespaces.

* Consistency groups can have one or more subsystem.
* Volumes within the consistency group can have namespace maps from both the subsystems. 

...
image:snapmirror-active-sync-alua-active-optimized.png[SnapMirror active sync ALUA active optimized paths]
...
image:snapmirror-active-sync-automatedfailoverduplex-scenario.png[SnapMirror active sync AutomatedFailoverDuplex scenario]

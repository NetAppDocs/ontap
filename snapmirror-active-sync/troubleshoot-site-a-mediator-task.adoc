...
| Consensus status of the SnapMirror active sync volume | `volume show _volume_name_ -fields smbc-consensus` | The `sm-bc consensus` field will read `Awaiting-consensus`
|===

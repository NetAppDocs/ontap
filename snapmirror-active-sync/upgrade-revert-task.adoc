...
== Revert to ONTAP 9.7 from ONTAP 9.9.1

[NOTE]
SnapMirror active sync is not supported with mixed ONTAP 9.7 and ONTAP 9.9.1 clusters.

When you revert from ONTAP 9.9.1 to ONTAP 9.7, you must be aware of the following:

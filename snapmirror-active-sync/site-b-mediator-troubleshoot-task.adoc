...
. Unmap all LUNs belonging to the consistency group from Site B. This will fail, so you must first modify the igroup to remove the replication peer SVM and then delete the lun map.

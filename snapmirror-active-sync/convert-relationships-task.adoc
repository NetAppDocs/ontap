...
== Convert an existing SnapMirror relationship to a SnapMirror active sync relationship
...
* This procedure create an asynchronous SnapMirror active sync configuration. Once you complete these steps, you can then <<Convert to a symmetric active/active relationship>>.

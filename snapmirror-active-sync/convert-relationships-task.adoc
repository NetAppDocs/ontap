...
. Delete LUN maps on the igroups associated with remote hosts.
+
[NOTE]
...
== Convert an existing SnapMirror relationship to asymmetric SnapMirror active sync relationship

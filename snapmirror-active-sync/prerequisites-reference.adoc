...
+
[NOTE]
If your ONTAP storage systems were purchased before June 2019, see link:https://mysupport.netapp.com/site/systems/master-license-keys[ONTAP Master License Keys^] to get the required SnapMirror synchronous license.

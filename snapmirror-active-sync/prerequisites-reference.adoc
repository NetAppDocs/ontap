...
* 4 (ONTAP 9.16.1 with Symmetric AA configurations)
...
== Supported protocols
SnapMirror active sync supports SAN protocols.  The FC and iSCSI protocols are supported beginning with ONTAP 9.9.1.  The NVMe protocol is supported beginning with ONTAP 9.17.1.

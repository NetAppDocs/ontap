...
a| All Flash FAS (AFF)
a| A-Series, C-Series
a| Automated Failover (SMAS AA/A), Automated Failover Duplex (SMAS A/A)
a| 2-node, 4-node clusters
a| All San Array (ASA)
a| A-Series, C-Series
a| Automated Failover, Automated Failover Duplex
a| 2-node, 4-node clusters
a| ASAr2 
a| -
a| Automated Failover Duplex

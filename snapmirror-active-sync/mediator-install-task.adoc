...
Beginning with ONTAP 9.17.1, you can also configure link:cloud-mediator-install-task.html[ONTAP Cloud Mediator] to monitor the health of your cluster in a SnapMirror active sync configuration. 

...
Beginning with ONTAP Mediator 1.12.1 and ONTAP 9.19.1,  you can use the same ONTAP Mediator instance to monitor one SnapMirror active sync cluster peer relationship and one four-node MetroCluster IP configuration if the following requirements are met:

...
.About this task
You'll need to replace the SMBC cluster's self-signed certificates with third-party certificates, remove the ONTAP Mediator configuration from ONTAP,and then add the ONTAP Mediator.

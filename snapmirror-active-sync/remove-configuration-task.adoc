...
+
`SiteA::> igroup remove -vserver _svm_name_ -igroup _igroup_name_ -os-type _os_type_ -initiator _host2_
SiteA::> igroup modify -vserver _svm_name_ -igroup _igroup_name_ -os-type _os_type_ -replication-peer "-"`
+

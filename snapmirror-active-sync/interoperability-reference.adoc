...
Beginning with ONTAP 9.19.1, ARP/AI supports primary volumes that participate in SnapMirror active sync SAN relationships. For more information, see link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations[Autonomous Ransomware Protection use cases and considerations].

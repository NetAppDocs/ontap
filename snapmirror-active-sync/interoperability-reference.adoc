...
=== AIX
For ONTAP 9.11.1 and later, AIX is supported with SnapMirror active sync via standard engineering Feature Policy Variance Request (FPVR) with the agreement that the following stipulations are understood: 

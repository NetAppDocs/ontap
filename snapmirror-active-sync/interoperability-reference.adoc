...
For ONTAP 9.19.1 and later, an Active/Active configuration is supported for AIX, enabling non-disruptive SnapMirror active sync operation. For additional information, see the NetApp Knowledge Base article: link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/SnapMirror_active_sync_support_for_AIX%3A_behavior_by_ONTAP_release_and_migration_guidance[SnapMirror active sync support for AIX: behavior by ONTAP release and migration guidance^]

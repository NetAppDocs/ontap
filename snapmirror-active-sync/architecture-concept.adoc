...
* Only one other SnapMirror asynchronous relationship is supported for volumes being protected for business continuity. In NAS configurations, only a volume-based asynchronous relationship is supported. SVM or consistency group asynchronous relationships are not supported.

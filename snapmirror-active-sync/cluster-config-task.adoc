...
. At least one SAN LIF (either FC or iSCSI as applicable) for your SAN configuration, or at least one NAS LIF (either NFS or SMB as applicable) is createdon each node in both clusters.
+

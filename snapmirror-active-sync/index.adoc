...
SnapMirror active sync supports automatic resync beginning with ONTAP 9.15.1, enabling copies to return to an InSync state once the intercluster network condition is resolved.  

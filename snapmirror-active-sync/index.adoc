...
In asymmetric active/passive configurations data on the secondary site is proxied to a LUN, namespace or storage unit.  
...
Primary-first and primary bias are supported in SnapMirror active sync beginning with ONTAP 9.15.1. Primary copies are designated in System Manager and output with the ONTAP REST API and ONTAP CLI. 

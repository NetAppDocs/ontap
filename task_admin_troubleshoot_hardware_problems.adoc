...
---
= Troubleshoot hardware problems with ONTAP System Manager
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
.2+h| Platform 11+h| Supported in System Manager in ONTAP version...
^h| 9.18.1 ^h| 9.17.1 ^h| 9.16.1 ^h| 9.15.1 ^h| 9.14.1 ^h| 9.13.1 ^h| 9.12.1 ^h| 9.11.1 ^h| 9.10.1 ^h| 9.9.1 ^h| 9.8 (preview mode only) 
...
12+a| &#42; Install the latest patch releases to view these devices.
|===
--
...
// 2026 Jan 28, ONTAPDOC-2863
// 2026 FEB 04, ONTAPDOC-3688
// 2026 FEB 10, ONTAPDOC-3688
// 2026 FEB 11, ONTAPDOC-3688
// 2026 JUN 04, ONTAPDOC-3919
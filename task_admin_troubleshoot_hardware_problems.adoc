...
.2+h| Platform 10+h| Supported in System Manager in ONTAP version...
^h| 9.17.1 ^h| 9.16.1 ^h| 9.15.1 ^h| 9.14.1 ^h| 9.13.1 ^h| 9.12.1 ^h| 9.11.1 ^h| 9.10.1 ^h| 9.9.1 ^h| 9.8 (preview mode only) 

...
= Learn about cluster management on ONTAP System Manager dashboards
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
Beginning with ONTAP 9.19.1, SVM administrators can monitor and manage their own SVMs using a dedicated SVM administrator dashboard in ONTAP System Manager. For more information, see link:task_svm_admin_dashboard_sm.html[Manage and monitor SVMs with System Manager]. 

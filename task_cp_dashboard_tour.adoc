...
The Network view displays the type of clients connected to the network. Each of these network elements are represented by a number (for example “NVMe/FC 16”). Select the number to view specific details on each of these network elements.

...
summary: "Many NetApp customers have significant amounts of stored data that is rarely accessed. We call that cold data. Customers also have data that is frequently accessed, which we call hot data. Ideally, you want to keep your hot data on your fastest storage for best performance. Cold data can move to slower storage as long as it is immediately available if needed. Learn how to know which parts of your data are hot and which are cold."
---
= FabricPool
:icons: font
:imagesdir: ../media/
...
link:../concept_cloud_overview.html[FabricPool System Manager doc]

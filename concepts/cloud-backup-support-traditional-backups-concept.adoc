...
Cloud Manager also provides backups of CVO instances using a Software as a Service (SaaS) model. Users can back up their CVO instances to S3 and S3-compliant public cloud object storage using Cloud Backup found on NetApp Cloud Central.

...
a| Volumes are still in Autonomous Ransomware Protection learning mode
a| Needs attention
a| One or more volumes have been in the anti-ransomware learning mode for 90 days.
a|
*Recommended*: Enable the Autonomous Ransomware Protection active mode for those volumes.
...
a| Needs attention
a| Autonomous Ransomware Protection is disabled on one or more volumes.  
a|
*Recommended*: Enable Autonomous Ransomware Protection on the volumes. Otherwise, you might not notice when volumes are being threatened or under attack.

a| Storage VMs aren't configured for Autonomous Ransomware Protection
a| Best practice
a|One or more storage VMs aren't configured for Autonomous Ransomware Protection.
a|
*Recommended*: Enable Autonomous Ransomware Protection on the storage VMs. Otherwise, you might not notice when storage VMs are being threatened or under attack. 

...
[NOTE]
NetApp regularly enhances our support for vSphere and other VMware technologies. You should review the https://library.netapp.com/ecm/ecm_download_file/ECMLP2492508[ONTAP Release Notes^] for specific information about your ONTAP release including any known limitations. For example, ONTAP 9.15.1 includes support for creating a persistent reservation for a VMware virtual volume using SCSI-3.

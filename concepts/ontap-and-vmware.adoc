...
[NOTE]
Beginning with ONTAP 9.15.1, you can create a persistent reservation for a virtual volume using SCSI-3. This feature is only supported using ONTAP Tools for VMware vSphere (OTV) 9 with a Windows Server Failover Cluster (WSFC).

...
= Learn about ONTAP and VMware vSphere
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
VMware Live Site Recovery formerly known as Site Recovery Manager (SRM) provides a disaster recovery capability. Live Site Recovery integrates with ONTAP tools for VMware vSphere to access and leverage the ONTAP data management functionality.

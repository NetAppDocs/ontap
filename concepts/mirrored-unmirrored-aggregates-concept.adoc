...
---
= Mirrored and unmirrored ONTAP local tiers
:icons: font
:imagesdir: ../media/
...
When you create a local tier, you can specify whether the local tier is mirrored or unmirrored.

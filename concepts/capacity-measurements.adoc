...
[.lead]
System capacity can be measured as either physical space or logical space. 
...
== Capacity reporting in the ONTAP CLI
...
== Capacity reporting in ONTAP System Manager

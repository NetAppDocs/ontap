...
---
= Learn about ONTAP storage platforms
:icons: font
:imagesdir: ../media/
...
* *ONTAP storage personalities*: https://docs.netapp.com/us-en/ontap-family/#[AFX and ASA r2 storage systems^] running dedicated ONTAP personalities that deliver disaggregated ONTAP storage focused on specific protocols.

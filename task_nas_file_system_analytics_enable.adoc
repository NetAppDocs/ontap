...
Beginning in ONTAP 9.13.1, you can modify configuration settings to enable File System Analytics by default on new volumes.

If you enable File System Analytics by default, you will have capacity analytics and Activity Tracking data.
...
.System Manager
--
If you are using System Manager, you can modify the storage VM or cluster settings to enable capacity analytics and Activity Tracking at volume creation by default
...
. In the **Capacity** field, enter the names of the storage VMs you want capacity analytics enabled for by default. Leaving the field blank will leave capacity analytics disabled on all SVMs. 
+
...
.CLI
--
You can configure the storage VM to enable File System Analytics by default using the ONTAP CLI.

.Enable File System Analytics at the SVM level
. Modify the SVM to enable capacity analytics and activity tracking on all newly created volumes:

...
NOTE: Beginning in July 2024, content from the technical report TR-4015: NetApp and Zero Trust: Enabling a data-centric Zero Trust model, which was previously published as a PDF, has been integrated with the rest of the ONTAP product documentation. 

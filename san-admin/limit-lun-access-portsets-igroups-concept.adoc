...
summary: "In addition to using Selective LUN Map, you can limit access to your LUNs through igroups and portsets."
---
...
image:bsag-c-mode-no-portset.png[image illustrating LUN access without a portset]

...
summary: "You can use the non-volatile memory express protocol to provide storage in a SAN environment. The NVMe protocol is optimized for performance with solid state storage."
---
= NVMe Overview
:icons: font
:imagesdir: ../media/

...
image::../media/bsag_c-mode_iSNS_register.png[SVM and iSNS server interaction example 1]
...
image::../media/bsag_c-mode_iSNS_connect.png[SVM and iSNS server interaction example 2]

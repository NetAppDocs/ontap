...
== Considerations for iSCSI LIF Failover

[.Lead]
You should familiarize yourself with aspects of iSCSI LIF failover automatic and manual migration, including how existing iSCSI LIFs and newly created iSCSI LIFs are affected.

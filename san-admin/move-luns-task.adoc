...
Beginning with ONTAP 9.10.1, you can use System Manager to create a new volume when you move a single LUN.  In ONTAP 9.8 and 9.9, the volume to which you are moving your LUN must exist before you begin the LUN move.

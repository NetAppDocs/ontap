...
summary: "Microsoft Offloaded Data Transfer, also known as copy offload, enables direct data transfers within a storage device or between compatible storage devices without transferring the data through the host computer."
---
...
When using VMware and Microsoft copy offload in virtualized environments, your LUNs must be aligned. Unaligned LUNs can degrade performance. link:io-misalignments-properly-aligned-luns-concept.html[Learn more about Unaligned LUNs].

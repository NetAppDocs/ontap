...
summary: "You can manage the availability of the iSCSI service on the iSCSI logical interfaces of the storage virtual machine by using the vserver iscsi interface enable or vserver iscsi interface disable commands."
---

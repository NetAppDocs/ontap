...
. Select *Enable NVMe/FC* or *Enable NVMe/TCP*.
. If you are enabling NVMe/TCP and you want network paths to automatically fail over to the HA partner in case of a node failure do the following:
+

...
A FlexClone license must be installed. This license is include with link:../system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one[ONTAP One].

...
[NOTE]
If you want to give a high priority to a host that was added to your a subsystem in ONTAP 9.13.1 or earlier, you can xref:change-host-priority-nvme-task.html[change the host priority].
...
----
+
If you want to change the default priority of the host from regular to high, use the `-priority high` option. 

...
. f you have an AFF, ASA or FAS system, follow these steps to create a LIF:  If you have an ASA r2 system, follow link:https://docs.netapp.com/us-en/asa-r2/administer/manage-client-vm-access.html#create-a-lif-network-interface[this System Manager procedure^] to create a LIF.  

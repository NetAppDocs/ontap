---
sidebar: sidebar
permalink: san-admin/provision_storage.html
...
If a procedure for your specific host is not listed, you can use these steps to provision storage for any host.  

This procedure creates new LUNs on an existing storage VM . LUNs appear to your host as disk devices.

You must have an FC license and your FC or iSCSI protocol should already be set up.  If the FC license is not enabled, the LIFs and SVMs appear to be online but the operational status is down. 

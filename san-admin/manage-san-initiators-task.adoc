...
+
*	Click image:icon_add_blue_bg.png[Blue plus sign icon] to add an igroup.
...
*	Hover over the igroup, then click image:icon_kabob.gif[kabob icon] next to an igroup name to edit or delete the igroup.

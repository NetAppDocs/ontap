...
summary: "You can control input/output performance to LUNs by assigning LUNs to Storage QoS policy groups. You might control input and output performance to ensure that workloads achieve specific performance objectives or to throttle a workload that negatively impacts other workloads."
---

...
summary: The NetApp All-Flash SAN Arrays are available beginning with ONTAP 9.7. ASAs are all-flash SAN-only solutions built on proven AFF NetApp platforms.
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf[NetApp Technical Report 4080: Best Practices for Modern SAN^]

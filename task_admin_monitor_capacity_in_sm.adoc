...
You must link:manage-max-cap-limit-smv-in-sm-task.html[enable the maximum capacity limit of a storage VM] before you can view it.
...
* To edit the maximum capacity limit of a storage VM, see link:manage-max-cap-limit-smv-in-sm-task.html#edit-max-cap-limit-svm[Edit the maximum capacity limit of a storage VM]
* For more details about the measurements, see link:./concepts/capacity-measurements-in-sm-concept.html[Capacity measurements in System Manager].

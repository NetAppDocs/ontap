...
keywords: system manager, logical storage, used storage, local tier capacity, aggregate capacity, block, add capacity, available capacity, total capacity, snapshot copy, inactive data, overprovision, overflows, snapshot copy reserves

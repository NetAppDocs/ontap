...
summary: "One of the methods you can use to match clients in export policy rules is by using hosts listed in netgroups. You can load netgroups from a uniform resource identifier into SVMs as an alternative to using netgroups stored in external name servers."
---

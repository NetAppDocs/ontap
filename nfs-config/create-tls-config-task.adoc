...
* Learn more about `vserver nfs tls interface enable` in the link:https://docs.netapp.com/us-en/ontap-cli/vserver-nfs-tls-interface-enable.html[ONTAP command reference^].
...
Learn more about `vserver nfs tls interface disable` in the link:https://docs.netapp.com/us-en/ontap-cli/vserver-nfs-tls-interface-disable.html[ONTAP command reference^].
...
Learn more about `vserver nfs tls interface modify` in the link:https://docs.netapp.com/us-en/ontap-cli/vserver-nfs-tls-interface-modify.html[ONTAP command reference^].

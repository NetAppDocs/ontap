...
summary: "As an alternative to manually creating individual local UNIX groups, you can load a list of local UNIX groups into SVMs from a uniform resource identifier by using the vserver services name-service unix-group load-from-uri command."
---

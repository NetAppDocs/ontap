...
*Parameters for enabling TLS encryption*
...
a|`-lif`
a|The name of the logical interface on which you want to enable NFS over TLS.
a|

a|`-certificate-name`
a|The common name (CN) of the certificate used for NFS over TLS connections.
a|

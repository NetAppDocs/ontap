...
summary: "While performing SMTape backup and restore operations through NDMP or CLI, you must be aware of the maximum number of SMTape backup and restore sessions that can be performed simultaneously on storage systems with different system memory capacities. This maximum number depends on the system memory of a storage system."
---

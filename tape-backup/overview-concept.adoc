...
summary: "ONTAP supports tape backup and restore through Network Data Management Protocol. NDMP allows you to back up data in storage systems directly to tape, resulting in efficient use of network bandwidth. ONTAP supports both dump and SMTape engines for tape backup."
---

...
summary: "Aliasing simplifies the process of device identification. Aliasing binds a physical path name or a serial number of a tape or a medium changer to a persistent, but modifiable alias name."
---

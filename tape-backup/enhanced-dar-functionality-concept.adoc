...
summary: "You can use the enhanced direct access recovery functionality for directory DAR and DAR of files and NT streams. By default, enhanced DAR functionality is enabled."
---

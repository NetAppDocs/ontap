...
summary: "Before you perform dump backup or restore operations, you should understand how these operations work with storage failover or aggregate relocation operations. The -override-vetoes option determines the behavior of dump engine during a storage failover or ARL operation."
---
= How dump works with ONTAP storage failover and ARL operations
:icons: font
:imagesdir: ../media/

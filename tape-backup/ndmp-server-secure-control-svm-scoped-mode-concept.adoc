...
summary: "A secure control connection can be established between the Data Management Application and NDMP server by using secure sockets as the communication mechanism. This SSL communication is based on the server certificates."
---

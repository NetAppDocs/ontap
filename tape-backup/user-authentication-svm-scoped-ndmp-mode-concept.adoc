...
summary: "In the storage virtual machine-scoped NDMP mode, NDMP user authentication is integrated with role-based access control. In the SVM context, the NDMP user must have either the vsadmin or vsadmin-backup role. In a cluster context, the NDMP user must have either the admin or backup role."
---

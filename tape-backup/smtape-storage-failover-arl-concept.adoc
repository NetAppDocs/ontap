...
summary: "Before you perform SMTape backup or restore operations, you should understand how these operations work with storage failover or aggregate relocation operation. The -override-vetoes option determines the behavior of SMTape engine during a storage failover or ARL operation."
---

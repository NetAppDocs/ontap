...
Upgrade ONTAP documentation available at: link:index.html[Upgrade ONTAP]
The list of checks are available at: link:task_what_to_check_before_upgrade.html[What should I verify before I upgrade with or without Upgrade Advisor]

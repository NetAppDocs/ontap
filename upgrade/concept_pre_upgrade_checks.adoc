...
---
= Summary or pre-upgrade checks for special considerations
:icons: font
:imagesdir: ../media/

[.lead]
Depending on your environment, you might need to perform certain additional steps before you start an ONTAP software upgrade. Review the table below to see if any special considerations apply to your environment that might require additional pre-upgrade information or procedures.

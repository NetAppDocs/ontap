...
|9.13.1
|direct multi-hop (requires images for 9.12.1 and 9.13.1)
...
|multi-stage
-9.7 -> 9.8
-9.8 -> 9.13.1 (direct multi-hop, requires images for 9.12.1 and 9.13.1)

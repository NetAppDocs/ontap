...
Automated and manual upgrades from ONTAP 9.8 and later follow the same upgrade paths.

.From ONTAP 9.15.1 and later 
[%collapsible%]
====

The following upgrade paths are supported from ONTAP 9.15.1 and later for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.14.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.13.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.12.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.11.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.10.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.9.1 for automated and manual upgrades.
...
The following upgrade paths are supported from ONTAP 9.8 for automated and manual upgrades.
...
For ONTAP 9.7 and 9.6 the automated and manual upgrade paths might vary based on the target ONTAP release.  
...
The manual upgrade path from ONTAP 9.7 to 9.10.1 and 9.11.1 varies from the automated upgrade path.  These variations are noted in the table below. For upgrades from ONTAP 9.7 to all other ONTAP versions, automated and manual upgrades follow the same upgrade path.
...
The manual upgrade path from ONTAP 9.6 to 9.10.1 varies from the automated upgrade path.  The variation is noted in the table below. For upgrades from ONTAp 9.6 to all other ONTAP versions, automated and manual upgrades follow the same upgrade path.
...
The upgrade paths from ONTAP 9.5 vary based upon whether you are performing an automated or a manual upgrade. 
...
Use the following upgrade paths for automated upgrades from ONTAP 9.5.
...
Use the following upgrade paths for manual upgrades from ONTAP 9.5
...
The upgrade paths from ONTAP 9.4, 9.3, 9.2, 9.1 and 9.0 vary based upon whether you are performing an automated upgrade or a manual upgrade.

.Automated upgrade paths
[%collapsible]
====

Use the following upgrade paths for automated upgrades from ONTAP 9.4, 9.3, 9.2, 9.1 and 9.0.
...
[%collapsible]
====
Use the following upgrade paths for manual upgrades from ONTAP 9.4, 9.3, 9.2, 9.1 and 9.0.

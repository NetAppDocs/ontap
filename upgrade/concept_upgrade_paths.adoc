...
If you are upgrading a MetroCluster configuration from 9.8 to 9.10.1 on any of the following platforms, you must upgrade to 9.9.1 before you upgrade to 9.10.1.  
...
MetroCluster configurations on these platforms, cannot upgrade from 9.8 directly to 9.10.1.

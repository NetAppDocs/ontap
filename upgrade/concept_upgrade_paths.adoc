...
.From ONTAP 9.15.1 and later 
[%collapsible%open]
====

The following upgrade paths are supported for ONTAP 9.15.1 and later for automated and manual upgrades.
...
The following upgrade paths are supported for ONTAP 9.14.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.14.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.13.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===

|If your current ONTAP release is 9.13.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.12.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.12.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.11.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.11.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.10.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.10.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.9.1. for automated and manual upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.9.1 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The following upgrade paths are supported for ONTAP 9.8 for automated and manual upgrades.
...
[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.8 |And your target ONTAP release is… |Your automated or manual upgrade path is…
...
The manual upgrade path from ONTAP 9.7 to 9.10.1 and 9.11.1 varies from the automated upgrade path.  These variations are noted in the table below. For upgrades to all other ONTAP versions, automated and manual upgrades follow the same upgrade path.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.7 |And your target ONTAP release is… |Your upgrade path is…
...
The manual upgrade path from ONTAP 9.6 to 9.10.1 varies from the automated upgrade path.  This variation is noted in the table below. For upgrades to all other ONTAP versions, automated and manual upgrades follow the same upgrade path.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.6 |And your target ONTAP release is… |Your automated upgrade path is…
...
.From ONTAP 9.5 - Automated upgrade paths
[%collapsible%]
====

The upgrade paths from ONTAP 9.5 might vary based upon whether you are performing an automated or a manual upgrade. Use the following upgrade paths for automated upgrades.

[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.5|And your target ONTAP release is… |Your automated upgrade path is…
...
// 9.5 Manual
.From ONTAP 9.5 - Manual upgrade paths
[%collapsible%]
====
...
[cols="25,25,50", options="header"]
|===
|If your current ONTAP release is 9.5 |And your target ONTAP release is… |Your manual upgrade path is…
...
// 2026 May 07, ONTAPDOC-3841
// 2025 Nov 06, ONTAPDOC-3186

...
*Note*: If you upgrade from 9.7 to 9.10.1P2 or later P release, you can perform a direct multi-hop upgrade (ANDU only, requires images for 9.8 & 9.10.1P2 or later)

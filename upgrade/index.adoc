...
* Manual preparation
+
If you don't use Upgrade Advisor or the Upgrade Health Checker tool you need to link:prepare.html[prepare to upgrade manually]. Manual preparation requires the completion of multiple tasks to check for any known issues or blockers and ensure that your cluster meets the necessary requirements for the upgrade.
+

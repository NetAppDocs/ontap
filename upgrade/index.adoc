...
f you want assistance upgrading your ONTAP software, NetApp Professional Services offers alink:https://www.netapp.com/pdf.html?item=/media/19393-netapp-managed-upgrade-service-description.pdf[Managed Upgrade Service]. The NetApp Managed Upgrade Service and other levels of upgrade support are also available to to customers with link:https://www.netapp.com/services/support/supportedge/[SupportEdge Services].

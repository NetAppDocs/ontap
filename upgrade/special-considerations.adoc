...
| Do I have long-term retention snapshots enabled on the middle volume of a cascade?
...
| Am I upgrading to ONTAP 9.19.1 RC and planning to enable ARP on volumes in SnapMirror synchronous or SnapMirror active sync relationships?
| link:../anti-ransomware/use-cases-restrictions-concept.html#arp-sm-oos-after-upgrade[Review temporary OutOfSync behavior and automatic resynchronization when enabling ARP]
|===

// 2026-6-5,contap-719516
// 2025 Oct-10, ONTAPDOC-3355

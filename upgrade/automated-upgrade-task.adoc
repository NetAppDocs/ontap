...
+
If you are performing a link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html#types-of-upgrade-paths[direct multi-hop upgrade], you should download both of the ONTAP images required for your specific link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html#supported-upgrade-paths[upgrade path].
...
+
[NOTE]
If you are upgrading a MetroCluster configuration, should perform this step on Cluster A and the repeat this step on Cluster B.

...
[NOTE]
If you are upgrading to ONTAP 9.15.1 or later through the NetApp, follow the link:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html[upgrade procedure in the NetApp Console documentation^].

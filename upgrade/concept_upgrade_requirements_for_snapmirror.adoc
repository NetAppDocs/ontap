...
* If you are upgrading clusters with DP SnapMirror relationship, you must upgrade the destination cluster/nodes before you upgrade the source cluster/nodes.

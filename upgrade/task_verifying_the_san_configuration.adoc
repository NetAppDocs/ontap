...
---
= Verify SAN host configuration
:icons: font
:imagesdir: ../media/

[.lead]
Upgrading in a SAN environment changes which paths are direct. Before you upgrade, you should verify that each host is configured with the correct number of direct and indirect paths, and that each host is connected to the correct LIFs.

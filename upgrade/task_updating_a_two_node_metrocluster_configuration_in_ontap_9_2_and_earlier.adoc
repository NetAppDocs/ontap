...
If you have a two-node MetroCluster configuration running ONTAP 9.3 or later, use the CLI steps in xref:task_upgrade_andu_sm.html[Install the ONTAP image with automated nondisruptive ONTAP upgrade].

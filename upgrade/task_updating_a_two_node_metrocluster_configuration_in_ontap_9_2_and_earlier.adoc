...
---
= Upgrade a two-node MetroCluster configuration in ONTAP
:icons: font
:imagesdir: ../media/
...
If you have a two-node MetroCluster configuration running ONTAP 9.3 or later, use the CLI steps in link:automated-upgrade-task.html[Install the ONTAP image with automated nondisruptive ONTAP upgrade].

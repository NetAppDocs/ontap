...
[.lead]
The method you use to upgrade -- nondisruptive or disruptive, automated or manual -- depends upon your configuration.  Automated nondisruptive upgrade (ANDU) using System Manager is the preferred method, and it supports most configurations.

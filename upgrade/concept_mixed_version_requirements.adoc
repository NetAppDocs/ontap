...
. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade/upgrade-create-aggregate-move-volumes.html[Migrate the data] from the nodes you are removing from the cluster to the new nodes you are adding to the cluster.

...
---- 
+
If there is a difference between the ONTAP version reported for the cluster and the individual nodes, update all nodes to the same ONTAP and patch version by running a link:concept_upgrade_methods.html[cluster image update]. 

...
---
= Verify your cluster after an ONTAP upgrade
:icons: font
:imagesdir: ../media/
...
* The per-ring quorum primary should be the same for all nodes.
+
Note that each ring might have a different quorum primary.

...
. Review the _Upgrade cautions_ section and the _Known problems and limitations_ section listed in the link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2492508 [ONTAP 9 Release Notes] for your target release.
+

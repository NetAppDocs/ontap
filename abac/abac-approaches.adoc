...
//todo: fix overall structure. use === instead of bold. reorder and combine sections?
...
You can enable or disable NFS 4.2 security labels with the following advanced privilege option:
...
[NOTE]
Follow the security policies of your organization.

//todo: the above note seems redundant...
...
//todo: what Python code is this referring to???

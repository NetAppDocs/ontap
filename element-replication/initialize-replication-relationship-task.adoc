...
You must specify the Element source path in the form `_hostip:_/lun/_name_`, where "`lun`" is the actual string "`lun`" and `_name_` is the name of the Element volume.

...
image:ems-config-workflow.png[This illustration is a flowchart of the EMS configuration workflow for high-severity events. The steps in the workflow diagram match the topics in this guide.]

...
You can find the EMS Event Catalog under More Resources on this page: https://mysupport.netapp.com/documentation/productlibrary/index.html?productID=62286[ONTAP 9 Product Library^]. See link:convert-ems-routing-to-notifications-task.html[Convert the legacy event route-based routing to event notifications] for more information on how to perform the notification-based model conversion. 

...
summary: "Before you install, configure, and connect Digital Advisor Unified Manager, you should have specific information about your environment readily available. You can record the information in the worksheet."
---
= Digital Advisor Unified Manager worksheet
:icons: font
:imagesdir: ../media/

[.lead]
Before you install, configure, and connect Digital Advisor Unified Manager, you should have specific information about your environment readily available. You can record the information in the worksheet.

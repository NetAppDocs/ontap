...
image::../media/qos-ceiling.gif[Chart comparing QoS before and after throughput ceiling applied.]
...
image::../media/qos-floor.gif[Two charts comparing QoS throughput before and after a floor is applied.]

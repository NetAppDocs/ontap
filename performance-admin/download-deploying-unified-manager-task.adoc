...
summary: "To install the software, you must download the virtual appliance installation file and then use a VMware vSphere Client to deploy the file to a VMware ESXi server. The VA is available in an OVA file."
---

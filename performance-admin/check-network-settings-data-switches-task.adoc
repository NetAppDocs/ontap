...
summary: "Although you must maintain the same MTU settings on your clients, servers and storage systems, intermediate network devices such as NICs and switches should be set to their maximum MTU values to ensure that performance is not impacted."
---

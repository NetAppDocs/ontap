...
summary: Create volumes to provide storage for Windows servers using the SMB protocol with ONTAP System Manager (9.7 and later).
---
...
[.lead]
Create volumes to provide storage for Windows servers using the SMB protocol with ONTAP System Manager (9.7 and later).

...
summary: Create volumes to provide storage for Windows servers using the SMB protocol using ONTAP System Manager, which is available with ONTAP 9.7 and later ONTAP 9 releases.
---
...
[.lead]
Create volumes to provide storage for Windows servers using the SMB protocol using ONTAP System Manager, which is available with ONTAP 9.7 and later ONTAP 9 releases.

...
summary: "Configure share permissions by creating access control lists for SMB shares enables you to control the level of access to a share for users and groups."
---

...
summary: "By default, an anonymous, unauthenticated user can access certain information on the network. You can use a SMB server option to configure access restrictions for the anonymous user."
---

...
summary: "There are specific ONTAP commands for managing DACL access control entries. You can add ACEs to NTFS DACLs at any time. You can also manage existing NTFS DACLs by modifying, deleting, and displaying information about ACEs in DACLs."
---

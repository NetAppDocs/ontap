...
summary: "You can display detailed information about restricted groups that are defined as Group Policy Objects in Active Directory and that are applied to the CIFS server."
---

...
summary: "You can display information about BranchCache configurations on storage virtual machines, which can be used when verifying a configuration or when determining current settings before modifying a configuration."
---

...
summary: "You can configure BranchCache for individual shares or for all SMB shares. If you choose per-share configuration, you must enable BranchCache on each SMB share that should provide caching."
---
...
[.lead]
To use BranchCache, you must configure your clients and, if needed, the hosted cache servers in branch offices where content will be cached. You can configure BranchCache for individual shares or for all SMB shares. If you choose per-share configuration, you must enable BranchCache on each SMB share that should provide caching. You can also set BranchCache to enable caching automatically on all SMB shares.

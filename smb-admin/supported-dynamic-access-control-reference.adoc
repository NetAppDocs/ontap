...
summary: "If you want to use Dynamic Access Control on your CIFS server, you need to understand how ONTAP supports Dynamic Access Control functionality in Active Directory environments."
---

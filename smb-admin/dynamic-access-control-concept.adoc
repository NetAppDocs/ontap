...
summary: "There are certain considerations you must keep in mind when using Dynamic Access Control and central access policies to secure files and folders on CIFS servers."
---

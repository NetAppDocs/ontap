...
summary: "You can display a list of all members of local groups configured on the cluster or on a specified storage virtual machine. This information can be useful when troubleshooting file-access issues or user-rights issues."
---

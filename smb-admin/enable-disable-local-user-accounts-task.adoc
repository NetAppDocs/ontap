...
summary: "You enable a local user account if you want the user to be able to access data contained in the storage virtual machine over an SMB connection. You can also disable a local user account if you do not want that user to access SVM data over SMB."
---

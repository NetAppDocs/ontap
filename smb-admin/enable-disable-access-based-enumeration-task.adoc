...
summary: "You can enable or disable access-based enumeration on SMB shares to allow or prevent users from seeing shared resources that they do not have permission to access."
---

...
summary: "You can flush all cached hashes from the BranchCache hash store on the storage virtual machine. This can be useful if you have changed the branch office BranchCache configuration. For example, if you recently reconfigured the caching mode from distributed caching to hosted caching mode, you would want to flush the hash store."
---

...
summary: "When access-based enumeration is enabled on an SMB share, users who do not have permission to access a folder or file contained within the share do not see that shared resource displayed in their environment."
---

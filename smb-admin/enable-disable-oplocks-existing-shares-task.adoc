...
a|
Enter the following command: `vserver share properties add -vserver _vserver_name_ -share-name share_name -share-properties oplocks```
[NOTE]
====
...
a|
Enter the following command: `vserver share properties remove -vserver _vserver_name_ -share-name _share_name_ -share-properties oplocks`
[NOTE]
====

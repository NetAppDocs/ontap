...
a|
Enter the following command: `vserver share properties add -vserver vserver_name -share-name share_name -share-properties oplocks```
[NOTE]
====
...
a|
Enter the following command: `vserver share properties remove -vserver vserver_name -share-name share_name -share-properties oplocks`
[NOTE]
====

...
summary: "Before creating an SVM that is configured as a disaster recovery destination where the identity is not preserved, you should know about how SMB server security settings are managed on the destination SVM."
---

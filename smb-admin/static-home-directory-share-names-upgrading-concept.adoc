...
summary: "Home directory share names must contain either the Windows user name or the UNIX user name dynamic variable. You should be aware of what happens to existing static home directory share names after upgrading to a version of ONTAP with the new requirement."
---

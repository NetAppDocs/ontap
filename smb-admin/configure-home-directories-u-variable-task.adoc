...
summary: "You can create a home directory configuration where you designate the share name using the Windows user name variable but you use the UNIX user name variable to designate the relative path to the home directory share. Users can then connect to their home share using dynamically shares created using their Windows user name without being aware of the actual name or path of the home directory."
---

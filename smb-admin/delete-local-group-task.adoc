...
summary: "You can delete a local group from the storage virtual machine if it is no longer needed for determining access rights to data associated with that SVM or if it is no longer needed for assigning SVM user rights to group members."
---

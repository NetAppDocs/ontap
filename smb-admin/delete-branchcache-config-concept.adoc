...
summary: "If you previously configured BranchCache but do not want the storage virtual machine to continue providing cached content, you can delete the BranchCache configuration on the CIFS server. You must be aware of what happens when you delete the configuration."
---

...
summary: "If you want the Active Directory-integrated DNS server to dynamically register the SMB server’s DNS records in DNS when you move the SMB server to another domain, you must modify dynamic DNS on the storage virtual machine before moving the SMB server."
---

...
summary: "You can verify the audit policy to confirm that the files or folders on the storage virtual machine to which you applied the security policy have the desired audit security settings."
---

...
summary: "You can create a home directory configuration using the Windows user name and home directory variables. Users can then connect to their home share using dynamically created shares."
---

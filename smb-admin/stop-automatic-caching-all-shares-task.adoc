...
summary: "If your BranchCache configuration automatically enables caching on all SMB shares on each storage virtual machine, you can modify the BranchCache configuration to stop automatically caching content for all SMB shares."
---

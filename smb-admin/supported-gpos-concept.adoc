...
summary: "Although not all Group Policy Objects are applicable to your CIFS-enabled storage virtual machines, SVMs can recognize and process the relevant set of GPOs."
---

...
summary: "You should be aware of what happens when reverting to a version of ONTAP that does not support Dynamic Access Control and what you must do before and after reverting."
---

...
summary: "You can verify the file security settings to confirm that the files or folders on the storage virtual machine to which you applied the security policy have the desired settings."
---

...
summary: "Beginning with ONTAP 9, you can configure signing and sealing to enable LDAP session security on queries to an Active Directory server. You must configure the CIFS server security settings on the storage virtual machine to correspond to those on the LDAP server."
---

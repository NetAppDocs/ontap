...
summary: "You can view information about SMB shares on your SVM and perform some management tasks using the Microsoft Management Console. Before you can view the shares, you need to connect the MMC to the SVM."
---

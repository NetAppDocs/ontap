...
summary: "Creating an NTFS security descriptor is the first step in configuring and applying NTFS access control lists to files and folders residing within storage virtual machines. You can associate the security descriptor to the file or folder path in a policy task."
---

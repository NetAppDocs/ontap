...
. Determine the name of the local user account that you want to delete: `vserver cifs users-and-groups local-user show -vserver vserver_name`
. Delete the local user: `vserver cifs users-and-groups local-user delete -vserver vserver_name ‑user-name username_name`

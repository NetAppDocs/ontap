...
summary: "You can enable or disable access-based enumeration on SMB shares from a Windows client, which allows you to configure this share setting without needing to connect to the CIFS server."
---

...
summary: "You can display information about SMB server security settings on your storage virtual machines. You can use this information to verify that the security settings are correct."
---

...
summary: "Creating an NTFS security descriptor audit policy is the first step in configuring and applying NTFS access control lists to files and folders residing within SVMs. You will associate the security descriptor to the file or folder path in a policy task."
---

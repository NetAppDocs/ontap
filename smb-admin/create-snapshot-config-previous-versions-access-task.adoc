...
+
For more information about configuring and managing Snapshot policies and Snapshot schedules, see https://docs.netapp.com/us-en/ontap/data-protection/index.html[Data Protection].

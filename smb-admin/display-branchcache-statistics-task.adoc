...
+
For more information about collecting statistics, see the _Performance Monitoring Power Guide_.
+
----
...
+
For more information about displaying statistical information, see the _Performance Monitoring Power Guide_.
+
----

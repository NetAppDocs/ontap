...
summary: "You can enable or disable local users and groups for SMB access on storage virtual machines. Local users and groups functionality is enabled by default."
---

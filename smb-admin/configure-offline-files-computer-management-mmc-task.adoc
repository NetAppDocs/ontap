...
summary: "If you want to permit users to cache files locally for offline use, you can configure offline files support by using the Computer Management MMC."
---

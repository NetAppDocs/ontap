...
summary: "You can change the BranchCache server key by modifying the BranchCache configuration on the storage virtual machine and specifying a different server key."
---

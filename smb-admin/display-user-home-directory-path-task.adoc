...
summary: "You can display an SMB user’s home directory path on the storage virtual machine, which can be used if you have multiple CIFS home directory paths configured and you want to see which path holds the user’s home directory."
---

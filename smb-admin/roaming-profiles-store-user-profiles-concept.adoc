...
summary: "ONTAP supports storing Windows roaming profiles on a CIFS server associated with the storage virtual machine. Configuring user roaming profiles provides advantages to the user such as automatic resource availability regardless of where the user logs in. Roaming profiles also simplify the administration and management of user profiles."
---

...
summary: "You can display a list of all local groups configured on the cluster or on a specified storage virtual machine. This information can be useful when troubleshooting file-access issues to data contained on the SVM or user-rights issues on the SVM."
---

...
summary: "You can display information about Group Policy Object configurations that are defined in Active Directory and about GPO configurations applied to the CIFS server."
---

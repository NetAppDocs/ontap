...
[source,cli]
----
vserver cifs users-and-groups update-names -vserver <SVM_name> -display-failed-only false
----
...
[source,cli]
----
vserver cifs users-and-groups update-names -vserver <SVM_name> -display-failed-only true
----

...
|===
Learn more about `statistics catalog object show`, and which objects and counters are available, in the link:https://docs.netapp.com/us-en/ontap-cli/statistics-catalog-object-show.html[ONTAP command reference^].

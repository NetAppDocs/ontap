...
summary: "When you create a CIFS server on your storage virtual machine, default administrative shares are automatically created. You should understand what those default shares are and how they are used."
---

...
summary: "You can display information about file security on files and directories contained within volumes on storage virtual machines. You can display information about audit policies on FlexVol volumes. If configured, you can display information about Storage-Level Access Guard and Dynamic Access Control security settings on FlexVol volumes."
---

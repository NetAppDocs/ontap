...
summary: "You can create additional home directory configurations using the Windows user name, home directory, and UNIX user name variables, which enables you to customize the home directory configuration to meet your needs."
---

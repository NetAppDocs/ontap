...
summary: "Server Message Block is a remote file-sharing protocol used by Microsoft Windows clients and servers. All SMB versions are supported. You should verify that the ONTAP SMB server supports the clients and functionality required in your environment."
---

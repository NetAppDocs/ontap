...
summary: "The CIFS server create-process uses the default organizational unit CN-Computers during setup unless you specify a different OU. You can move CIFS servers to different OUs after setup."
---

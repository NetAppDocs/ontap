...
summary: Use disk encryption to ensure that volume data cannot be read if the
...
. If you see a message that disks need to be rekeyed, click image:icon_kabob.gig[Menu icon]

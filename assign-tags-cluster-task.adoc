...
[.lead]
Beginning with ONTAP 9.14.1, you can use System Manager to assign tags to a cluster to identify objects that belong to a category, for example, a project or a cost center.
...
== Manage tags
You can assign a tag to a cluster. First, you need to add the tag.  Then, you can also edit or delete the tag.

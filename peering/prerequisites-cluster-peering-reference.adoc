...
[NOTE]
Beginning with ONTAP 9.6, cluster peer encryption provides TLS 1.2 AES-256 GCM encryption support for data replication.
"PSK-AES256-GCM-SHA384" security ciphers are required for cluster peering to work even if encryption is disabled.

...
summary: "You can use the cluster peer create command or System Manager to create a peer relationship between a local and remote cluster. After the peer relationship has been created, you can repeat the task on the remote cluster to authenticate it to the local cluster."
---

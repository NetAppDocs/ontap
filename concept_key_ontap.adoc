...
If you are familiar with ONTAP 9.6 or earlier, you will feel right at home. There are a few terminology changes with System Manager that you should be aware of.

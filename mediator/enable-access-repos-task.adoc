...
.Procedure for Oracle Linux 10.x operating system
[%collapsible]
====
Use this procedure if your operating system is *Oracle Linux 10.x* to enable access to repositories:
...
.Procedure for Oracle Linux 9.x operating system
[%collapsible]
====
Use this procedure if your operating system is *Oracle Linux 9.x* to enable access to repositories:
...
.Procedure for Rocky Linux 10, 9, or 8 operating systems
[%collapsible]
====

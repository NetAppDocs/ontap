...
. Enable access to the repositories listed above so ONTAP Mediator can access the required packages during the installation process.
+
...
* Procedure for <<rocky-linux-8, Rocky Linux 8>> operating system.
* Procedure for <<rocky-linux-9, Rocky Linux 9>> operating system.
...
.Procedure for Rocky Linux 8 operating system
[%collapsible]
====
Use this procedure if your operating system is *Rocky Linux 8* to enable access to repositories:
...
.Procedure for Rocky Linux 9 operating system
[%collapsible]
====
Use this procedure if your operating system is *Rocky Linux 9* to enable access to repositories:

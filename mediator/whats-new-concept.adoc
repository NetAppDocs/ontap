...
* Implemented a fix for successful installation of ONTAP Mediator 1.6 fails in reboot_needed() because of rpm command failure 

* ONTAP Mediator 1.8 Negative Certificate Validation hard-stop 
...
* ONTAP Mediator Health Check events and ONTAP support operations 
* Upgrade scst package to 3.8.0 
* ONTAP Mediator 1.8 Script to validate certificate setup 
* ONTAP Mediator 1.8 Script to validate certificate setup - Improvements and Corrections 

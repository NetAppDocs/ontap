...
* Support for installing an ONTAP Mediator that only uses the HTTPS protocol. The SCST package is not installed if this installation method is used. link:index.html#https-iscsi-installation[Learn more about HTTPS and iSCSI installation options for ONTAP Mediator].

...
* Support for monitoring multiple MetroCluster IP configurations using an ONTAP Mediator configured with HTTPS installed on a host OS running 8-core CPU and with at least 16GB RAM. Refer to

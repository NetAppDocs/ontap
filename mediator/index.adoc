...
+
CAUTION: When installed with HTTPS support only, ONTAP Mediator can only be used to monitor one MetroCluster IP configuration. Monitoring multiple configurations is not supported. 

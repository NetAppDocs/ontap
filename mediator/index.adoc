...
* Beginning with ONTAP 9.19.1 and ONTAP Mediator 1.12, you can configure an HTTPS-based Mediator to monitor your MetroCluster IP configuration. 
...
NOTE: For SnapMirror active sync customers, ONTAP doesn't require port 3260 to be enabled or connected.

...
* From June 15, 2025, ONTAP Mediator versions 1.8 and 1.9 can't be installed or upgraded because their code signing certificates will have expired. If installation or upgrade fails, use the ONTAP Mediator 1.9.1 patch version instead. 
====

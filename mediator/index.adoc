...
When you install or upgrade to ONTAP Mediator 1.12, you have the option to install ONTAP Mediator with both iSCSI and HTTPS support, or HTTPS support only. If you choose to install ONTAP Mediator with HTTPS support only, the SCST package is not installed. 
...
If your configuration meets the following requirement, you can install ONTAP Mediator with HTTPS support only:
...
NOTE: If you installed ONTAP Mediator 1.12 or later with HTTPS support only, the SCST package is not installed so the kernel compatibility requirements do not apply. 
...
* If you installed ONTAP Mediator 1.12 or later with HTTPS support only, you can skip this task. 

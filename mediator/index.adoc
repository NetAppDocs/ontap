...
If your configuration meets the following requirement, you can install ONTAP Mediator with support for HTTPS only:
...
* If you installed ONTAP Mediator 1.12 or later with support for HTTPS only, you can skip this task. 

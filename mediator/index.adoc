...
link:../media/console_output_mediator_installation.txt[Example of ONTAP Mediator 1.3 installation (console output)^]

link:../media/example_console_output_Mediator onedotfour.txt[Example of ONTAP Mediator 1.4 installation (console output)^]

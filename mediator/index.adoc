...
NOTE: For SnapMirror active sync or MetroCluster IP ONTAP Mediators that use HTTPS for communication, ONTAP doesn't require port 3260 to be enabled or connected.

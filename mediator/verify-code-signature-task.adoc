...
+
----
openssl ts -verify -data ontap-mediator-1.11.sig -in ontap-mediator-1.11.sig.tsr -CAfile tsa-prod-chain-ONTAP-Mediator.pem -untrusted tsa-prod-ONTAP-Mediator.pem
openssl ts -verify -data ontap-mediator-1.11 -in ontap-mediator-1.11.tsr -CAfile tsa-prod-chain-ONTAP-Mediator.pem -untrusted tsa-prod-ONTAP-Mediator.pem
----
...
====
----
[root@scspa2695423001 ontap-mediator-1.11]# pwd
/root/ontap-mediator-1.11
[root@scspa2695423001 ontap-mediator-1.11]# ls -l
total 63660
...
-r-xr-xr-- 1 root root 65132818 Feb 20 15:17 ontap-mediator-1.11
-rw-r--r-- 1 root root      384 Feb 20 15:17 ontap-mediator-1.11.sig
-rw-r--r-- 1 root root     5437 Feb 20 15:17 ontap-mediator-1.11.sig.tsr
-rw-r--r-- 1 root root     5436 Feb 20 15:17 ontap-mediator-1.11.tsr
...
[root@scspa2695423001 ontap-mediator-1.11]#
[root@scspa2695423001 ontap-mediator-1.11]# /root/verify_ontap_mediator_signatures.sh
++ openssl version -d
++ cut -d '"' -f2

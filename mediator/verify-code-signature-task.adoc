...
NOTE: This verification process is optional if the system cannot meet the requirements for running the check.
...
----
+
NOTE: To skip the automatic signature check during installation, use the following command: 
`./ontap-mediator-1.9.0/ontap-mediator-1.9.0  -y --skip-code-signature-check`
+
----

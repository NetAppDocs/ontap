...
a| `ontap-mediator-1.11.0.sig.tsr`       a| The revocation request for use by OCSCP for the installer’s signature
...
Warning: certificate from 'tsa-prod-ONTAP-Mediator.pem' with subject '/C=GB/ST=West Yorkshire/O' is not a CA cert
Verification: OK

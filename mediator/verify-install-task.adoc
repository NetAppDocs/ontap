...
summary: "After the ONTAP Mediator has been installed, you should verify that the ONTAP Mediator are running."
---
...
+
NOTE: If you installed ONTAP Mediator 1.12 or later with support for HTTPS and not iSCSI, the SCST package is not installed so you can skip this step.
+
----

...
link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/concept_mediator_requirements.html#guidelines-for-upgrading-the-ontap-mediator-in-a-metrocluster-configuration[Guidelines for upgrading the ONTAP Mediator in a MetroCluster configuration^]
...
* To use SnapMirror Business Continuity, see link:https://docs.netapp.com/us-en/ontap/smbc/smbc-install-confirm-ontap-cluster.html[Install ONTAP Mediator Service and confirm the ONTAP cluster configuration^]

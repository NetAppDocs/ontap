---
permalink: mediator/task-install-ontap-mediator.html
sidebar: sidebar
keywords: ontap, mediator, service, assist, install, requirements, mediator requirements
...
* To use the ONTAP Mediator service in a MetroCluster IP configuration, see the https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_configuring_the_ontap_mediator_service_from_a_metrocluster_ip_configuration.html[Configuring the ONTAP Mediator service from a MetroCluster IP configuration^]
* To use SnapMirror Business Continuity, see the https://docs.netapp.com/us-en/ontap/smbc/smbc-install-confirm-ontap-cluster.html[Install ONTAP Mediator Service and confirm the ONTAP cluster configuration^]

...
----
+
NOTE: To skip the automatic signature check during installation, use the following command: `./ontap-mediator-1.9.1/ontap-mediator-1.9.1 -y --skip-code-signature-check`

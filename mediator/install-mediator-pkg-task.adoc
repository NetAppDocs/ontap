...
** Respond `No` if you plan to only use ONTAP Mediator for SnapMirror active sync, or if you plan to use an ONTAP Mediator configured with HTTPS to monitor a single MetroCluster IP configuration.
+

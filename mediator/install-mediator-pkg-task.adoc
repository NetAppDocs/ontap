...
** To install ONTAP Mediator with support for HTTPS and iSCSI, respond `y`.
** If you are certain that you will only use ONTAP Mediator to monitor one MetroCluster IP configuration, you can install ONTAP Mediator with support for HTTPS only by responding `n`.
+

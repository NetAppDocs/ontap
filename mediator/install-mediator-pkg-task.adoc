...
[root@mediator_host ~]# ontap-mediator-1.10/ontap-mediator-1.10
...
+ Installing ONTAP Mediator. (Log: /root/ontap_mediator.T7uce6/ontap-mediator-1.10/ontap-mediator-1.10/install_20241017092214.log)

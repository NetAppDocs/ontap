...
** Respond `No` if you plan to only use ONTAP Mediator for SnapMirror active sync, or if you plan to configure ONTAP Mediator with HTTPS to monitor one or more MetroCluster IP configurations. 
+

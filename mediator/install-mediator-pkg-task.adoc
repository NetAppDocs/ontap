...
+
** For automation use cases, you can use the `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` command to skip the installer prompts.
+
Alternatively, you can use the `--https-only` option in the `./ontap-mediator-1.12.1/ontap-mediator-1.12.1` command to specify HTTPS only.
...
[NOTE] 
====
To skip signature check during installation, use this command: `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 --skip-code-signature-check`
====
+

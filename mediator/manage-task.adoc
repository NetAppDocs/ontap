...
NOTE: Prior to installing the ONTAP Mediator, check the SCST version. If the version used is greater than the version bundled with the ONTAP Mediator installer, this step is skipped.

...
[CAUTION]
====
* Third-party certificates are only supported from ONTAP Mediator version 9.16.1 and in some older ONTAP versions. See link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278[NetApp Bugs Online Bug ID CONTAP-243278^].

...
NOTE: Perform this step before installing the ONTAP Mediator. If the version used is greater than the minimum required version, the ONTAP Mediator install skips this step.

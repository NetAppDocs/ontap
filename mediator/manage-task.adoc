...
+
NOTE: If you're performing a first-time installation and want to pre-install SCST before installing ONTAP Mediator, you can skip this step. The ONTAP Mediator installer will apply any relevant patches to the SCST components during installation.

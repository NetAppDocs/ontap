...
[CAUTION]
====
* Third-party certificates are only supported with ONTAP Mediator on certain ONTAP versions. See link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278[NetApp Bugs Online Bug ID CONTAP-243278^].

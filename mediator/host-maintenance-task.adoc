...
NOTE: If you installed ONTAP Mediator 1.12 or later with support for HTTPS and not iSCSI, SCST is not installed and the host OS kernel can be upgraded without affecting ONTAP Mediator. Refer to your host OS documentation for upgrade instructions.
...
NOTE: If you installed ONTAP Mediator 1.12 or later with support for HTTPS and not iSCSI, SCST is not installed and you can skip this task.

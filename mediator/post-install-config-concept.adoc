...
+
NOTE: Toggling between disk spaces does not purge existing logs.  All previous logs are updated to the current state after toggling and restarting the Mediator.

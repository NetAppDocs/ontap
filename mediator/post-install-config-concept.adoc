...
NOTE: Other default values in the `ontap_mediator.config.yaml` should not be changed as modified values are not maintained during Mediator upgrades. To make a modification to Mediator, copy the variables to `ontap_mediator.user_config.yaml`.

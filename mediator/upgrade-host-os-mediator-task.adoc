...
* This task applies to ONTAP Mediator versions with SCST installed. If you installed ONTAP Mediator 1.12 or later with support for HTTPS but not iSCSI, the SCST package is not installed and you can upgrade the OS without affecting ONTAP Mediator. Refer to the OS vendor's documentation for OS upgrade instructions. After you upgrade the OS, if you need to upgrade your version of ONTAP Mediator, refer to link:mediator/install-mediator-pkg-task.html[Install or upgrade ONTAP Mediator].

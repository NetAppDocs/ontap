...
image::../media/scrn-en-drw-fcoe-dual-2p-targ.gif[FCoE initiator to FC target]
...
image::../media/scrn_en_drw_fcoe-mixed-ethernet.png[FCoE mixed with IP storage protocols]

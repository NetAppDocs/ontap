...
== Set queue depths on VMware hosts for a QLogic HBA
...
== Set queue depths on VMware hosts for an Emulex HBA
...
== Set queue depths on Windows hosts for an Emulex HBA
...
== Set queue depths on Windows hosts for a Qlogic HBA

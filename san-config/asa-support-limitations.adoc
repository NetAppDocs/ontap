...
For more information on persistent ports, see link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf[NetApp Technical Report 4080: Best Practices for Modern SAN^].

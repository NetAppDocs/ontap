...
summary: "Starting with ONTAP 9.3, you can use the SnapLock Event Based Retention (EBR) feature to define how long a file is retained after the occurrence of an event."
---
...
[.lead]
Starting with ONTAP 9.3, you can use the SnapLock _Event Based Retention (EBR)_ feature to define how long a file is retained after the occurrence of an event.

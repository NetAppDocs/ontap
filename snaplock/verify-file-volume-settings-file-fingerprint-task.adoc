...
summary: "You can use the volume file fingerprint start and volume file fingerprint dump commands to view key information about files and volumes, including the file type, the volume expiration date, and so forth."
---

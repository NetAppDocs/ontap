...
* Default retention period, with a default equal to `min` for both Compliance mode and Enterprise mode starting in ONTAP 9.10.1. In ONTAP releases earlier than ONTAP 9.10.1, the default retention period depends on the mode:

...
* FlexCache origin volumes
+
Supported beginning with ONTAP 9.16.1.

* SnapMirror synchronous
+
Beginning with ONTAP 9.19.1, you can specify the expiry time only during snapshot creation. You cannot set or extend the expiry time on existing snapshots.

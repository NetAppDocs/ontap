...
.System Manager
--
. Navigate to *Storage > Volumes* and select *Edit*.
...
. Navigate to *Storage > Volumes* and select a volume.
. In the volume details page, select the *Snapshot copies* tab.
. Select the Snapshot copy, click image:icon_kabob.gif[alt=Menu Options], and select *Modify SnapLock Expiration Time*. 
--

...
** link:../system-admin/install-license-task.adoc[Install the SnapLock license]. 
** link:initialize-complianceclock-task.adoc[Initialize the Compliance Clock]. 
** If you are using an ONTAP release earlier than 9.10.1, link:create-snaplock-aggregate-task.adoc[create a SnapLock aggregate].
...
* The source and destination volumes must be created in link:../peering/create-cluster-relationship-93-later-task.adoc[peered clusters] and link:../peering/create-intercluster-svm-peer-relationship-93-later-task.adoc[SVMs].

...
* link:commit-snapshot-copies-worm-concept.html[Commit Snapshot copies to WORM for secondary storage] 
...
* link:snapshot-lock-concept.html[Lock a Snapshot copy for protection against ransomware attacks]

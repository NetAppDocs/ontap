...
Encrypted volumes
a|
Yes, beginning with ONTAP 9.2. Learn more: xref:Encryption[xrefstyle=full].
a|
Yes, beginning with ONTAP 9.2. Learn more: xref:Encryption[xrefstyle=full].
...
No
a|
Yes, beginning with ONTAP 9.8. Learn more: xref:FabricPool on SnapLock Enterprise aggregates[xrefstyle=full]
...
FlexGroup volumes
a|
Yes, beginning with ONTAP 9.11.1. Learn more: xref:FlexGroup volumes[xrefstyle=full] 
a|
Yes, beginning with ONTAP 9.11.1. Learn more: xref:FlexGroup volumes[xrefstyle=full] 
...
a|
Yes, beginning with ONTAP 9.3. Learn more: xref:MetroCluster[xrefstyle=full]
a|
Yes, beginning with ONTAP 9.3. Learn more: xref:Metrocluster[xrefstyle=full]
...
SnapLock support FlexGroup volumes beginning with ONTAP 9.11.1; however, the following features are not supported:

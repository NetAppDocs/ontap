...
No
a|
Yes, beginning with ONTAP 9.8. Learn more about xref:FabricPool on SnapLock Enterprise aggregates[xrefstyle=full]
...
a|
Yes, beginning with ONTAP 9.3. Learn more about xref:MetroCluster support[xrefstyle=full].
a|
Yes, beginning with ONTAP 9.3. Learn more about xref:MetroCluster support[xrefstyle=full].

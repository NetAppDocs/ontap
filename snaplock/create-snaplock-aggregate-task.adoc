...
* The SnapLock link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html[license must be installed] on the node. This license in included in link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one[ONTAP One]. 

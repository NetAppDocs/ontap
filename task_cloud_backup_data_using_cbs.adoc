...
summary: Beginning with ONTAP 9.9.1, you can use System Manager to back up data in the cloud using Cloud Backup Service.
---
...
[.lead]
Beginning with ONTAP 9.9.1, you can use System Manager to back up data in the cloud using Cloud Backup Service.
...
. Select the Cloud Backup Service policy type.

. If the Cloud Backup Service is not enabled, select *Enable Cloud Backup Service*.

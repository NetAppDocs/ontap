...
If you use RBAC with the ONTAP REST API or System Manager, you will need to create custom roles to manage access to Activity Tracking. See LINK TO NEW LAST SECTION IN THIS TOPIC for this process. 
...
Learn more about RBAC roles and the ONTAP REST API [link to https://docs.netapp.com/us-en/ontap-automation/rest/rbac_overview.html]

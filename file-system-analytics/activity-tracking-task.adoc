...
If you use RBAC with the ONTAP REST API or System Manager, you will need to create custom roles to control access to Activity. See xref:considerations-concept.html#RBAC[Considerations for File System Analytics] for this process. 

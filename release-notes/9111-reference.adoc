...
|===
| Update | Description 
| xref:../networking/configure_network_security_using_federal_information_processing_standards_@fips@.html[TLSv1.3 support] | ONTAP supports TLS 1.3 for HTTPS and REST API management protocols, Cluster Peering Encryption, . TLS 1.3 is not supported with SP/BMC or with Cluster Peering Encryption.

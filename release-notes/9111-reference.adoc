...
|===
| Update | Description 
| xref:../networking/configure_network_security_using_federal_information_processing_standards_@fips@.html[TLSv1.3 support] | ONTAP supports TLS 1.3 for HTTPS and REST API management protocols, S3 storage, FlexCache, and Cluster Peering encryption. TLS 1.3 is not supported with SP/BMC, FabricPool, Microsoft Azure Page Blobs storage, or SnapMirror Cloud.

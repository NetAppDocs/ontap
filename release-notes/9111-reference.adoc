...
| xref:../consistency-groups/index.html#metrocluster[Consistency group support] | ONTAP Mediator software version 1.4 is supported in MetroCluster IP configurations.

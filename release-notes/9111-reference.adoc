...
a| xref:../consistency-groups/protect-task.html[Two-phase consistency group Snapshot copy creation] | In the REST API, consistency groups support a two-phase Snapshot procedure, enabling you to conduct a precheck before committing the Snapshot. 
|===

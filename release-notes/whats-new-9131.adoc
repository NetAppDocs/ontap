...
a|
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[Multi-admin verify functionality with Autonomous Ransomware Protection]
...
Beginning with ONTAP 9.12.1, System Manager is integrated with the NetApp Console. Learn more about xref:../concepts/sysmgr-integration-console-concept.html[System Manager integration with NetApp Console].

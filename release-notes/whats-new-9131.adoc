...
Beginning with ONTAP 9.12.1, System Manager is integrated with the NetApp Console. Learn more about xref:../sysmgr-integration-bluexp-concept.html[System Manager integration with NetApp Console].

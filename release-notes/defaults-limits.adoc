...
| The maximum number of asynchronous volume-level concurrent transfers has increased from 100 to 200. SnapMirror Cloud transfers has increased from 32 to 100 on high-end systems and from 6 to 20 SnapMirror transfers on low-end systems.
| ONTAP 9.8

...
|===
| Update | Description 
| xref:../task_admin_monitor_risks.html[System Manager displays risks reported by Digital Advisor] | Use System Manager to link to NetApp Active IQ Digital Advisor, which reports opportunities to reduce risk and improve the performance and efficiency of your storage environment.

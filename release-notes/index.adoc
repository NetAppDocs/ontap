...
ONTAP 9.14.1 delivers new and enhanced features in the areas of NFS session trunking for VMware workloads, improved cloud tiering performance, and more. For a complete list of new features and enhancements, see xref:9141-reference.adoc[What's new in ONTAP 9.14.1].
...
ONTAP 9.13.1 delivers new and enhanced features in the areas of security hardening, S3 bucket management, and more. For a complete list of new features and enhancements, see xref:9131-reference.adoc[What's new in ONTAP 9.13.1].
...
* link:link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_install_and_cable_the_mcc_components.html[MetroCluster IP enhancements: support for 8-node clusters^]
+

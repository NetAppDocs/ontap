...
+
Extends Autonomous Ransomware Protection (ARP/AI) to SnapMirror synchronous for (SAN and NAS) and SnapMirror active sync SAN environments, preserving detection and recovery signals in zero‑RPO architectures. 

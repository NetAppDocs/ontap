...
[.lead]
Each release of the ONTAP 9 data management software presents delivers new features and enhanced features that ments, improveing the capabilities, manageability, performance, and security offerings in ONTAP.

Find You can find the highlighted new features for recent by ONTAP 9 releases on this page, or you can use the sidebar to navigate to a specific ONTAP 9 version to learn about all the entire set of the enhancements in that ONTAP release.
...
//placeholder
* xref:../nfs-trunking/index.html[NFSv4.1 session trunking]
+
...
* xref:../fabricpool/enable-disable-volume-cloud-write-task.html[Write directly to the cloud with FabricPool] 
+
...
* xref:../flexgroup/manage-flexgroup-rebalance-task.html[Proactive FlexGroup rebalancing]
+
...
For a complete list of new features and enhancements, see xref:9141-reference.adoc[What's new in ONTAP 9.14.1].
...
For a complete list of new features and enhancements, see xref:9131-reference.adoc[What's new in ONTAP 9.13.1].
...
For a complete list of new features and enhancements, see xref:9121.adoc[What's new in ONTAP 9.12.1].
...
For a complete list of new features and enhancements, see xref:9111-reference.adoc[What's new in ONTAP 9.11.1].
...
For a complete list of new features and enhancements, see xref:91-1-reference.adoc[What's new in ONTAP 9.10.1].

== What's new in ONTAP 9.9.1 

//placeholder 

* link:../snaplock/index.html[Storage efficiency support on SnapLock volumes and aggregates]
+
Storage efficiency capabilities for SnapLock volumes and aggregates have been extended to include data compaction, cross-volumededuplication, adaptive compression, and TSSE (Temperature Sensitive Storage Efficiency), allowing for greater space savings for WORM data.
...
* xref:../flexgroup/supported-unsupported-config-concept.html[SVM disaster recovery support for FlexGroup volumes]
+
...
* xref:../task_cloud_backup_data_using_cbs.html[Cloud Manager integration]
+
System Manager users can set up protection to back up data to public cloud endpoints using the Cloud Backup Service.

For a complete list of new features and enhancements, see xref:991-reference.adoc[What's new in ONTAP 9.9.1].

...
[TIP]
This table is helpful, but because these docs are live, it would likely be better to just actively maintain this info relative to each version on this page since we are not clearly stating what year a release happened, no?

...
ONTAP 9.18.1 delivers new and enhanced features in the areas of security, scalability, and storage management to support data infrastructure modernization. These enhancements helps you scale, operate more efficiently, and secure data for the future. For a complete list of new features and enhancements, see xref:whats-new-9181.adoc[What's new in ONTAP 9.18.1].

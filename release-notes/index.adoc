...
You can find the highlighted new features for recent ONTAP 9 releases on this page or use the sidebar to navigate to a specific ONTAP 9 version to learn about all the entire set of the enhancements in that ONTAP release.

...
[.lead]
Each release of the ONTAP 9 data management software delivers new features and enhanced features that improve the capabilities, manageability, performance, and security offerings in ONTAP.

You can find the highlighted new features for recent ONTAP 9 releases on this page or use the sidebar to navigate to a specific ONTAP 9 version to learn about all the enhancements in that ONTAP release.
...
ONTAP 9.14.1 delivers new and enhanced features in the areas offerings FabricPool, anti-ransomware protection, OAuth, more. For a complete list of new features and enhancements, see xref:9141-reference.adoc[What's new in ONTAP 9.14.1].
...
+
ARP allows you more granular control over event security, allowing you to adjust the conditions that create alerts and reducing the possibility for false positives. 
...
+
ONTAP S3 now supports the object-lock API command, enabling you to protect data written to ONTAP with S3 from deletion 
...
** xref:../anti-ransomware/use-cases-restrictions-concept.html#multi-admin-verification-with-volumes-protected-with-arp[Multi-admin verification (MAV) support for ARP]
+
ARP disable commands are supported by MAV. MAVy ensures that no single administrator can disable ARP, exposing the data to potential attack by ransomware.
** xref:../anti-ransomware/use-cases-restrictions-concept.html[FlexGroup support for ARP]
+
...
+
ONTAP 9.13.1 allows you to group objects such as volumes, LUNs, or files into groups and assign a QoS ceiling (max IOPs) or floor (min IOPs), improving application performance expectations.  

== ONTAP 9.12.1 highlights 

ONTAP 9.12.1 delivers new and enhanced features in the areas of security hardening, retention, performance, and more. For a complete list of new features and enhancements, see xref:9121.adoc[What's new in ONTAP 9.12.1].
...
ONTAP 9.10.1 delivers new and enhanced features in the areas of security hardening, performance analytics, NVMe protocol support, and object storage backup options. For a complete list of new features and enhancements, see xref:91-1-reference.adoc[What's new in ONTAP 9.10.1].

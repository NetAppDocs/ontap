...
For details about hardware platform and switch support, known issues, and limitations in all ONTAP 9 versions, or for features introduced in releases prior to ONTAP 9.9.1, refer to the _link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2492508[ONTAP 9 Release Notes^]_. You must sign in with your NetApp account or create an account to access the Release Notes.

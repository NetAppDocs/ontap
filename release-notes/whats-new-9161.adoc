...
a|
Beginning with ONTAP 9.16.1, your FSx deployments detects that you are in an air-gapped region, going to the log-in page brings you into System Manager, enabling you to manage FSx with System Manager. 

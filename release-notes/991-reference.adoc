...
| xref:../smb-config/configure-client-access-shared-storage-concept.html[SMB access support in qtress] | SMB access is supported to qtrees in FlexVol and FlexGroup volumes with SMB enabled.
|===

...
NOTE: After upgrading to ONTAP 9.19.1 RC and enabling ARP, the relationship might experience a brief Out‑of‑Sync state. This condition is temporary, and the relationship should automatically resynchronize without any intervention.

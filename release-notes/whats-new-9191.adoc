...
*  xref:../nfs-admin/enable-disable-nfsv42-task.html[Enable or disable NFSv4.2 for ONTAP SVMs]
...
a|
xref:../networking/configure_tls_offload.html[TLS offload configuration]
a|

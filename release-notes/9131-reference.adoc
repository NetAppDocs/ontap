...
a| 
* link:../snapmirror-active-sync/add-remove-consistency-group-task.htmll[Non-disruptively add volumes to a consistency group with an active SnapMirror active sync relationship.]
* link:../snapmirror-active-sync/interoperability-task.html[Utilize NDMP restore with SnapMirror active sync].

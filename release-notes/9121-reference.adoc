...
| xref:../snaplock/commit-snapshot-copies-worm-concept.html[SnapLock for SnapVault is supported on FlexGroup volumes] | SnapLock for SnapVault support for FlexGroup volumes | SnapLock for SnapVault is supported on FlexGroup volumes.

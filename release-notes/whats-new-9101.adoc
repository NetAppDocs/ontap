...
| xref:../task_admin_monitor_risks.html[Review risk mitigation recommendations and acknowledge the risks reported by Digital Advisor] | System Manager users can view the risks reported by Active IQ Digital Advisor and review recommendations about mitigating the risks. Beginning with 9.10.1, users can also acknowledge risks.

...
a| xref:../consistency-groups/protect-task.html[Two-phase consistency group snapshot creation] | In the ONTAP REST API, consistency groups support a two-phase snapshot procedure, enabling you to conduct a precheck before committing the snapshot. 
|===

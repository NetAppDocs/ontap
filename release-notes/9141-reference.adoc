...
|===
| Update | Description 
| xref:../s3-config/index.html[S3 object storage support on mirrored and unmirrored aggregates] | Enable an S3 object storage server on an SVM in a mirrored or unmirrored aggregate in MetroCluster IP and FC configurations.

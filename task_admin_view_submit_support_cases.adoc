...
NOTE: To receive alerts about firmware updates, you must be registered with Digital Advisor Unified Manager. Refer to link:https://netapp.com/support-and-training/documentation/active-iq-unified-manager[Digital Advisor Unified Manager documentation resources^].

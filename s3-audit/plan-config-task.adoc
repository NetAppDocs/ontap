...
See the link:http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-cmpr-970/TOC__vserver__object-store-server.html[`vserver object-store-server audit create`] man page for syntax details.

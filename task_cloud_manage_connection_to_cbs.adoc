...
summary: Beginning with ONTAP 9.9.1, you can view the status of the connection to the Cloud Backup Service.
---
...
[.lead]
Beginning with ONTAP 9.9.1, you can use System Manager to back up data in the cloud using the Cloud Backup Service.  You can manage the connection to the Cloud Backup Service and view details about the number and capacity of the volumes that are backed up using the service.

...
permalink: networking-app/monitor_the_reachability_of_network_ports.html
keywords: monitor, monitoring, manage, managing, automatic, reachability, port, network, identify, determine
summary: Determine when the physical network topology does not match the ONTAP configuration
---

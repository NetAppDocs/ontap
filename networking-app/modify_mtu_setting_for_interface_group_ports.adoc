...
permalink: networking-app/modify_mtu_setting_for_interface_group_ports.html
...
. Modify the broadcast domain settings: `broadcast-domain modify -broadcast-domain broadcast_domain_name -mtu mtu_setting`
+
...
. Enter y to continue.
. Verify that the MTU setting were modified correctly: `net port show`

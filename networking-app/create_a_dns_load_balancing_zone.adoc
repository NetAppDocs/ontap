...
permalink: networking-app/create_a_dns_load_balancing_zone.html
...
The Knowledgebase article _How to set up DNS load balancing in Cluster-Mode_ on the NetApp Support Site contains more information about configuring DNS load balancing using conditional forwarding.

...
* Creating a new firewall policy that is an exact copy of an existing policy. You can use this to make a policy with similar characteristics within the same SVM, or to copy the policy to a different SVM.

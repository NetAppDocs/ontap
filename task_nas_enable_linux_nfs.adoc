...
* For existing storage VMs: click *Storage > Storage VMs*, select a storage VM, click *Settings*, and then click image:icon_gear.gif[Actions icon] under *NFS*. Beginning with ONTAP 9.19.1, you can control NFSv4.2 availability.
+

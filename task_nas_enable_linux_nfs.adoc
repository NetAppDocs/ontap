...
+
NOTE: FPolicy monitoring of NFSv4.2 file access events is not supported. If you configure FPolicy monitoring, you need to disable NFSv4.2 on the SVM. For reference, see link:./nfs-admin/enable-disable-nfsv42-task.html[Enable or disable NFS for ONTAP SVMs].

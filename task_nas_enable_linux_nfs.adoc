...
Enable a new or existing storage VM for the NFS protocol using this procedure. Be sure that you have configuration details for any networking, authentication, or security services required in your environment before you begin.

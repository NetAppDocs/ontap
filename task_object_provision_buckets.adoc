...
If you are provisioning buckets in a Cloud Volumes ONTAP environment, you should use the CLI procedure for better performance. Learn about link:create-bucket-task.html[configuring buckets with the CLI].

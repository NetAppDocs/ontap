...
Be sure to check the https://imt.netapp.com[NetApp Interoperability Matrix^] to confirm compatibility between your current ONTAP and VSC releases.

To set up NFS access for ESXi hosts to datastores using System Manager Classic (for ONTAP 9.7 and earlier releases), see https://docs.netapp.com/us-en/ontap-sm-classic/nfs-config-esxi/index.html[NFS configuration for ESXi using VSC overview^]

...
Beginning with ONTAP 9.16.1, you can also enable link:enable-adv-capacity-flexgroup.adoc[advanced capacity balancing] to redistribute a large file's data between FlexGroup member volumes.

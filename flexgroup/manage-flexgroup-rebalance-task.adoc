...
+
Any Snapshot copy created after the `granular-data` option is enabled cannot be replicated to a system running ONTAP 9.11.1 and earlier versions because they do not support multi-part inodes.

...
+
Rebalancing creates multipart inodes which in large numbers can degrade performance.  In a conversion, an estimated 50 to 85 percent of the data on a FlexVol volume is moved to a new constituent, resultin in the creation of many multipart inodes for those files.  

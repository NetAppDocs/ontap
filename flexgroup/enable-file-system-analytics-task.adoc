...
Beginning with ONTAP 9.10.1, you can enable Activity Tracking to view information on high traffic and high throughput activity on a volume.
...
Use System Manager or ONTAP REST APIs to display the analytic or Activity Tracking data.

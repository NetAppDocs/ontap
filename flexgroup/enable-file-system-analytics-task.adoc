...
[.lead]
The File System Analytics framework enables you to monitor data usage. Read about xref:../task_nas_file_system_analytics_view.adoc[how to enable File System Analytics] or xref:../event-performance-monitoring/activity-tracking.html[how to enable Activity Tracking].

...
== Features supported starting from ONTAP 9.4
...
== Features supported starting from ONTAP 9.3
...
== Feature supported starting from ONTAP 9.2

* Volume encryption
* Aggregate inline deduplication (cross-volume deduplication)
* NetApp volume encryption (NVE)

== Features supported starting from ONTAP 9.1

...
* xref:../volumes/enable-large-vol-file-support-task.html[Large volume support] increases FlexGroup volume member size from a maximum of 100TB to a maximum of 300 TB.
...
* xref:../ontap-metrocluster/index.html[MetroCluster configurations]

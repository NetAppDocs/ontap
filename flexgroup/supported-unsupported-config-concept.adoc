...
* Snapshot copy tagging: Support for creating, modifying and deleting Snapshot copy tags (SnapMirror labels and comments) for Snapshot copies on FlexGroup volumes.

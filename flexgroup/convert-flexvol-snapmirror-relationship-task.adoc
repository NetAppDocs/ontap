...
* FlexGroups with FlexVol volumes in SnapMirror/SnapVault relationships are not supported long-term beyond the conversion process. 
* FlexGroup conversion is supported only for SnapMirror asynchronous relationships.
* FlexGroup conversion is not supported in SnapMirror cloud relationships.
...
// 2025-Oct-29, GitHub issue# 1889
// 2025-Sept-16, ONTAPDOC-3314

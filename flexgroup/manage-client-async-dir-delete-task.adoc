...
Rights are granted per volume. 

You can move directories only. You cannot move files to the .ontaptrashbin directory.

link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously[Learn about using ONTAP to delete directories asynchronously from FlexVol and FlexGroup volumes].

== Enable client asynchronous directory delete

.Steps

. From the cluster CLI, enter advanced privilege mode: `-privilege advanced`
...
// 2026-June-29, ONTAPDOC-3925
// 2026-May-4, CONTAP-659508

...
. Click *Protect Volumes* to protect your volumes. To protect your LUNs, click *Storage > LUNs*, select a LUN to protect, and then click image:icon_protect.gif[Protect button].
+

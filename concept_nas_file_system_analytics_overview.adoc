...
[NOTE]
Beginning in ONTAP 9.13.1, File System Analytics is enabled by default on all newly created volumes. To manage these configuration settings, see xref:task_nas_file_system_analytics_enable.html[Enable File System Analytics].

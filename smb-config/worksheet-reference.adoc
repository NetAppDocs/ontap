...
`-default-site`
a|
Optional: Beginning with ONTAP 9.13.1, the default site used if a LIF does not have site membership and as a fallback if trusted-domain site discovery fails.
a|

...
+
NOTE: You can also save the specifications of these LUNs to an Ansible Playbook.  For more details, go to link:../task_use_ansible_playbooks_add_edit_volumes_luns.html[Use Ansible Playbooks to add or edit volumes or LUNs].

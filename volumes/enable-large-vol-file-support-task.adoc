...
---
= Enable ONTAP large volume and large file support
:icons: font
:imagesdir: ../media/
...
If you have enabled large volume and file support for an NFS client, the client must be remounted before the new maximum file size takes effect. 

...
summary: "Determine whether you need to increase the number of inodes for your FlexVol volumes to prevent them from hitting their file limit."
---
= Determine file and inode usage for an ONTAP volume
:icons: font
:imagesdir: ../media/

...
Beginning in ONTAP 9.13.1, the maximum number of inodes continues to grow so there is one inode per 32 KB of volume space even if the volume is larger than 680 GB. This growth continues until the volume reaches the inode maximum of 2,040,109,451.

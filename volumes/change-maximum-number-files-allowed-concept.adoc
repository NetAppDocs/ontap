...
---
= The default and maximum number of files allowed for ONTAP FlexVol volumes
:icons: font
:imagesdir: ../media/
...
* link:++https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/FAQ_-_ONTAP_default_and_maximum_number_of_files_(inodes)++[NetApp Knowledge Base: FAQ - ONTAP default and maximum number of files (inodes)^]

...
---
= Relocate a root volume to new aggregates in ONTAP
:icons: font
:imagesdir: ../media/
...
NOTE: A node reboot occurs during root volume relocation which terminates any active SSH sessions.

...
summary: "You can rehost a volume that serves data using the SMB protocol. To allow clients to continue accessing the data after the rehosting operation, you must manually configure policies and the associated rules."
---

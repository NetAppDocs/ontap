...
You can display a list of volumes that contain sequentially packed data, for instance, when you need to revert to an ONTAP release earlier than 9.13.1. 

.Step

. List volumes that contain sequentially packed data: 'volume efficiency show -extended-auto-adaptive-compression true'

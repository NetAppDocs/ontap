...
+
image:hardware-universe-products.png[Hardware Universe products menu]
. Select your platform. 
+
image:hardware-universe-platforms.png[Hardware Universe platforms menu]
. Select the appropriate version of ONTAP then **Show Results**. 
+
image:hardware-universe-os-filter.png[Hardware Universe OS filter menu]

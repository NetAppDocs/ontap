...
summary: "You can rehost a SAN volume that serves data through mapped LUNs. After re-creating the initiator group (igroup) in the destination SVM, volume rehost operation can automatically remap the volume at the same SVM."
---
= Rehost a SAN volume
:icons: font
:imagesdir: ../media/

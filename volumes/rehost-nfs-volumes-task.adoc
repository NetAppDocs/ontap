...
summary: "You can rehost volumes that serve data using the NFS protocol. To allow clients to continue accessing the data after the rehosting operation, you must associate the volume with the export policy of the SVM as well as manually configure the policies and associated rules."
---
= Rehost NFS volumes
:icons: font
:imagesdir: ../media/
...
[.lead]
You can rehost volumes that serve data using the NFS protocol. To allow clients to continue accessing the data after the rehosting operation, you must associate the volume with the export policy of the SVM as well as manually configure the policies and associated rules.

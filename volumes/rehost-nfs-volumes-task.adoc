...
summary: "You can rehost a volume that serves data using the NFS protocol. To allow clients to continue accessing the data after the rehosting operation, you must associate the volume with the export policy of the SVM as well as manually configure the policies and associated rules."
---

...
summary: "A quota enforced as a result of a default quota, rather than an explicit quota, is referred to as a derived quota."
---
= Learn about ONTAP derived quotas
:icons: font
:imagesdir: ../media/

...
summary: "Quotas are defined in quota rules specific to FlexVol volumes. These quota rules are collected together in a quota policy for a storage virtual machine and activated on each volume on the SVM."
---
= Learn about ONTAP quotas, quota rules, and quota policies
:icons: font
:imagesdir: ../media/

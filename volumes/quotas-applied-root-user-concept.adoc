...
summary: "The root user on UNIX clients is subject to tree quotas, but not to user or group quotas. This allows the root user to take actions on behalf of other users that would otherwise be prevented by a quota."
---
= Learn about ONTAP quotas being applied to the root user
:icons: font
:imagesdir: ../media/

...
It comes to your attention that a certain user, kjones, is taking up too much space in a critical qtree, proj1, which resides in vol1. You can restrict this user's space by adding the following quota rule:
